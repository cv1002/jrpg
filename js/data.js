...
// 任务完成共五处）、成就类 3200（试炼通关/真结局/成就解锁共三处）、更长档 2800（记忆碎片，仅一处）、教程 3600
// （仅一处）、图鉴 4200（仅一处）与战间 1400 家族、两处 setTimeout 1800 延时（存档回写/通关回世界）逐类保留不动。
// 本版只收口值恰为「2000 更强档」的三处 boxMsg。
