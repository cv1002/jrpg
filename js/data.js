...
// 任务完成共五处，由 v19.32 收口为下方 WIN_MSG_MS）、成就类 3200（试炼通关/真结局/成就解锁共三处）、更长档 2800
...
// 「更强档之上更长」的同一批值）。
// 注意：成就类 3200（试炼通关/真结局/成就解锁）、更长档 2800（记忆碎片，仅一处）、教程 3600（仅一处）、图鉴 4200
