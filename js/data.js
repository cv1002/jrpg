...
// 长档 2400（等级提升）与 2800（记忆碎片），逐类保留不动；ALTAR_TXT_MS=1600 与喷泉 1600 另为强敌/
// 小事件语义。本版只收口值恰为「2200 常规档」的五处，不改任何一语义对应的时间长度。
