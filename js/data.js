...
const HELP_PAGES=[
  ...
  [
    ...
    ['潮灯镇 Lv.' + MAPS.village.recLv,'商店·旅馆·酿造锅·灯长/守书记(支线)·喷泉回血 · 东门→雾语林','水塘灯影 · ' + NPCS.granny.name + '/' + NPCS.lampboat.name + ' · 广场大灯·村井 · 粮田（' + QUESTS.side_grain.name + '） · ' + NPCS.brewer.name + '（' + QUESTS.side_snake.name + '）'],
