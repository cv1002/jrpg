...
const HELP_PAGES=[
  ...
  [
    ...
    ['星井矿脉 Lv.' + MAPS.cave.recLv,'更强魔物·迷宫·试炼碑（可问' + NPCS.sentinel.name + '）·中央终焉水晶·双徽记化为门','无泉水/旅店 · 出发前请补给 · 星井（低鸣星蓝/静默灰） · ' + NPCS.digger.name + '（' + QUESTS.side_bone.name + '）'],
