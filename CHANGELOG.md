## v21.12 快速旅行页脚不再压住末行——页脚位置改由列表长度派生，第 4 条目的地后 6px 重叠收口（体验打磨·排版，承 v19.59 操作页排版 / v21.11 帮助页魔物状态页越界修复的「面板内侧一切文字互不重叠且落在画布内」主线：本轮轮到快速旅行面板做纵向体检——v19.53 无字回廊成为第 4 条目的地后，行距 52px 把末行 baseline 推到 266，页脚却一直硬编码 270 没跟着走）
