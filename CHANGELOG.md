## v21.8 持续伤害/反击反馈追加剩余 HP——灼烧、中毒、防御反击补上「结算后血量」最后三处黑盒（体验打磨·信息透明，v21.7 测试基建收口后轮换回「反馈家族」——承 v20.0 玩家攻击命中后敌方剩余 HP / v20.1 敌方回血后当前 HP / v20.2 敌方攻击命中后我方剩余 HP：三连把「主动伤害/回复/受击」都配上了精确血数，唯独玩家最常盯的「持续伤害 tick」与「防御反击」这三条战报仍只报伤害值，是同一家族的最后三处缺口）
