## v21.27 帮助页「试炼进阶」试炼碑位置行补守碑人指路——「可问守碑人」短指针让 NPC 从现地走进战前知识中枢（体验打磨·信息透明·可发现性，承 v21.24 守碑人 / v21.26 试炼碑提示即时化 / v21.23 三 Boss 预览「H 页是战前知识中枢」同主线：试炼碑旁 v21.24 新设的守碑人，是全图唯一能在碑前当面答疑试炼规矩的 NPC——三连战阵容/关间恢复/通关赏金都在他台词里按等级实时报数；但这位 NPC 此前只活在现地（玩家走到碑旁才撞见），H 页四页翻遍查无此人：战前知识中枢的「试炼碑位置」行——玩家决定「要不要去星井矿脉试炼」前读到的第一行——对「碑旁有个可以问的人」只字未提，与 v21.14/v21.18 反复点名的「功能存在就必须能看到入口」是同一类入口漏网）
