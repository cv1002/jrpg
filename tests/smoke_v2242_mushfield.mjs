...
ok('GAME_VERSION 字面量已为 v22.42（旧 v22.41 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.44';") && !dSrc.includes("const GAME_VERSION = 'v22." + "41';"));
...
ok('README tests 树收录 smoke_v2242_mushfield 且位于串尾', readme.includes('smoke_v2241_gatearch + smoke_v2242_mushfield + smoke_v2243_encguide + smoke_v2244_fulldanger（npm test 串跑）'));
ok('README 件套口径为一百四十件套（一百三十九件套清除）',
  readme.includes('冒烟一百四十件套（一百三十九件套清除）') && !readme.includes('冒烟一百三十七件套（一百三十六件套清' + '除）'));
...
ok('smoke_v2241 的 GAME_VERSION 字面量 pin 已更新为 v22.42', s2241.includes("const GAME_VERSION = 'v22.44';"));
ok('smoke_v2241 的 GAME_VERSION 恒等 pin 已更新为 === v22.42', s2241.includes("GAME_VERSION === 'v22.44'"));
ok('smoke_v2241 的 README 串尾 pin 已更新为 + smoke_v2242_mushfield',
  s2241.includes('smoke_v2241_gatearch + smoke_v2242_mushfield + smoke_v2243_encguide + smoke_v2244_fulldanger（npm test 串跑）'));
ok('smoke_v2241 的 package.json 件套计数 pin 已更新为 === 138', s2241.includes('testChain === 140'));
ok('smoke_v2241 的 README 件套口径 pin 已更新为一百三十八件套',
  s2241.includes('冒烟一百四十件套（一百三十九件套清除）'));
...
ok('smoke_v2240 的 README 串尾 pin 已更新为 + smoke_v2242_mushfield（NPC 总数 pin 随新现实）',
  s2240.includes('smoke_v2241_gatearch + smoke_v2242_mushfield + smoke_v2243_encguide + smoke_v2244_fulldanger（npm test 串跑）') && s2240.includes('testChain === 140'));
...
ok('smoke_v2226 的 plain 串尾锚逐字（node tests/smoke_v2241_gatearch.mjs && node tests/smoke_v2242_mushfield.mjs && node tests/smoke_v2243_encguide.mjs && node tests/smoke_v2244_fulldanger.mjs"）',
  s2226.includes('node tests/smoke_v2241_gatearch.mjs && node tests/smoke_v2242_mushfield.mjs && node tests/smoke_v2243_encguide.mjs && node tests/smoke_v2244_fulldanger.mjs"'));
