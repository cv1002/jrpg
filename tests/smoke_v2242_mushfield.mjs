...
ok('GAME_VERSION 字面量已为 v22.42（旧 v22.41 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.62';") && !dSrc.includes("const GAME_VERSION = 'v22." + "41';"));
...
ok('README 件套口径为一百五十八件套（一百五十七件套清除）',
  readme.includes('冒烟一百五十八件套（一百五十七件套清除）') && !readme.includes('冒烟一百三十七件套（一百三十六件套清' + '除）'));
...
ok('smoke_v2241 的 GAME_VERSION 字面量 pin 已更新为 v22.42', s2241.includes("const GAME_VERSION = 'v22.62';"));
ok('smoke_v2241 的 GAME_VERSION 恒等 pin 已更新为 === v22.42', s2241.includes("GAME_VERSION === 'v22.62'"));
...
ok('smoke_v2241 的 package.json 件套计数 pin 已更新为 === 138', s2241.includes('testChain === 158'));
ok('smoke_v2241 的 README 件套口径 pin 已更新为一百三十八件套',
  s2241.includes('冒烟一百五十八件套（一百五十七件套清除）'));
