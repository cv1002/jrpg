...
ok('GAME_VERSION 字面量已为 v22.42（旧 v22.41 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.84';") && !dSrc.includes("const GAME_VERSION = 'v22." + "41';"));
...
ok('契约：NPC 总数保持 30（零 NPC 变更，v22.39 pin 续守）', Object.keys(NPC_SPOTS).length === 35,
...
ok('README 件套口径为一百八十件套（一百七十九件套清除）',
  readme.includes('冒烟一百八十件套（一百七十九件套清除）') && !readme.includes('冒烟一百三十七件套（一百三十六件套清' + '除）'));
...
ok('smoke_v2241 的 GAME_VERSION 字面量 pin 已更新为 v22.42', s2241.includes("const GAME_VERSION = 'v22.84';"));
ok('smoke_v2241 的 GAME_VERSION 恒等 pin 已更新为 === v22.42', s2241.includes("GAME_VERSION === 'v22.84'"));
...
ok('smoke_v2241 的 package.json 件套计数 pin 已更新为 === 138', s2241.includes('testChain === 180'));
ok('smoke_v2241 的 README 件套口径 pin 已更新为一百三十八件套',
  s2241.includes('冒烟一百八十件套（一百七十九件套清除）'));
...
ok('smoke_v2240 的 README 串尾 pin 已更新为 + smoke_v2242_mushfield（NPC 总数 pin 随新现实）',
  s2240.includes('smoke_v2241_gatearch + smoke_v2242_mushfield + smoke_v2243_encguide + smoke_v2244_fulldanger + smoke_v2245_watcher + smoke_v2246_fountgauge + smoke_v2247_villagewell + smoke_v2248_mapguide + smoke_v2249_shopkeep + smoke_v2250_brewer + smoke_v2251_oathkeep + smoke_v2252_rail + smoke_v2253_supplypoint + smoke_v2254_grainfield + smoke_v2255_steleglow + smoke_v2256_campfire + smoke_v2257_pondglow + smoke_v2258_potionhelp + smoke_v2259_sandpile + smoke_v2260_fountripple + smoke_v2261_rich3 + smoke_v2262_crystal + smoke_v2263_ptime3 + smoke_v2264_hunt3 + smoke_v2265_lucky3 + smoke_v2266_stock3 + smoke_v2267_elixir3 + smoke_v2268_brew3 + smoke_v2269_mush3 + smoke_v2270_outstep + smoke_v2271_outstep2 + smoke_v2272_scholar2 + smoke_v2273_seen5 + smoke_v2274_seen2 + smoke_v2275_codexempty + smoke_v2276_lampkid + smoke_v2277_pondhint + smoke_v2278_mushguide + smoke_v2279_lampwell + smoke_v2280_grainfield + smoke_v2281_starwell + smoke_v2282_archgate + smoke_v2283_menuekey + smoke_v2284_skillekey（npm test 串跑）') && s2240.includes('testChain === 180'));
