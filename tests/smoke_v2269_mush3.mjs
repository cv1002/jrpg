...
ok('data.js GAME_VERSION 字面量已为 v22.69（旧 v22.68 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.86';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "68';"));
...
ok('CHANGELOG 顶为 v22.69 条目', changelog.startsWith('## v23.86 '));
...
ok('smoke_v2268 的 GAME_VERSION 字面量 pin 已更新为 v22.69', s2268.includes("const GAME_VERSION = 'v23.86';"));
...
ok('smoke_v2268 的 CHANGELOG 顶 pin 已更新为 ## v22.69', s2268.includes("startsWith('## v23.86'") || s2268.includes("startsWith('## v22.78 '"));
