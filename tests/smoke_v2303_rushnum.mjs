...
ok('data.js GAME_VERSION 字面量已为 v23.03（旧 v23.02 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.19';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "02';"));
...
ok('CHANGELOG 顶部已追加 v23.03 条目', changelog.startsWith('## v23.19 '));
...
ok('smoke_v2302 的 GAME_VERSION 字面量 pin 已更新为 v23.03', s2302.includes("const GAME_VERSION = 'v23.19';"));
ok('smoke_v2302 的 CHANGELOG 顶 pin 已更新为 ## v23.03',
  s2302.includes("startsWith('## v23.19 '"));
