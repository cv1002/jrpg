...
ok('GAME_VERSION 字面量已为 v22.34（旧 v22.33 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.18';") && !dSrc.includes("const GAME_VERSION = 'v22." + "33';"));
...
ok('smoke_v2233 的 GAME_VERSION 字面量 pin 已更新为 v22.34', s2233.includes("const GAME_VERSION = 'v23.18';"));
ok('smoke_v2233 的 GAME_VERSION 恒等 pin 已更新为 === v22.34', s2233.includes("GAME_VERSION === 'v23.18'"));
...
ok('smoke_v2232 的 GAME_VERSION 字面量 pin 已更新为 v22.34', s2232.includes("const GAME_VERSION = 'v23.18';"));
...
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.34', s2230.includes("const GAME_VERSION = 'v23.18';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.34', s2229.includes("GAME_VERSION === 'v23.18'"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.34', s2226.includes("const GAME_VERSION = 'v23.18';"));
// 旧代 v22.33 pin 全库零残留
