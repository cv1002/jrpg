...
ok('GAME_VERSION 字面量已为 v22.34（旧 v22.33 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.65';") && !dSrc.includes("const GAME_VERSION = 'v22." + "33';"));
...
ok('package.json test 串共 130 件套', testChain === 161, String(testChain));
...
ok('smoke_v2233 的 GAME_VERSION 字面量 pin 已更新为 v22.34', s2233.includes("const GAME_VERSION = 'v22.65';"));
ok('smoke_v2233 的 GAME_VERSION 恒等 pin 已更新为 === v22.34', s2233.includes("GAME_VERSION === 'v22.65'"));
ok('smoke_v2233 的 README 件套 pin 已随新现实更新为一百六十一件套（一百六十件套清除）',
  s2233.includes('一百六十一件套（一百六十件套清除）'));
...
ok('smoke_v2233 的 package.json 件套计数 pin 已更新为 === 130', s2233.includes('testChain === 161'));
ok('smoke_v2232 的 GAME_VERSION 字面量 pin 已更新为 v22.34', s2232.includes("const GAME_VERSION = 'v22.65';"));
...
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.34', s2230.includes("const GAME_VERSION = 'v22.65';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.34', s2229.includes("GAME_VERSION === 'v22.65'"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.34', s2226.includes("const GAME_VERSION = 'v22.65';"));
// 旧代 v22.33 pin 全库零残留
