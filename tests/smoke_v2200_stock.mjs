...
ok('GAME_VERSION 字面量已为 v22.0', GAME_VERSION === 'v22.18', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.0', dataSrc.includes("const GAME_VERSION = 'v22.18';"));
