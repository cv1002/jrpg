...
ok('GAME_VERSION 字面量已为 v22.0', GAME_VERSION === 'v23.81', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.0', dataSrc.includes("const GAME_VERSION = 'v23.81';"));
...
for (const nm of achFiles) {
  ...
  ok(`${nm} 的 README 成就 pin 已随新现实更新为 38 项双处落位`,
    src.includes("readme.includes('成就一览（全部 73 项进度'") && src.includes('**73 项成就**'));
}
