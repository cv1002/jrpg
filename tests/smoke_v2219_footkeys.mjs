...
// GAME_VERSION v22.19 / v2218..v2192 恒等 v22.19 / v2218..v2192 树尾 pin / package testChain === 127）、
...
ok('GAME_VERSION 字面量已为 v22.19（本版独占精确锚点）', GAME_VERSION === 'v22.31', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.19（旧 v22.18 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v22.31';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "18';"));
...
ok('README 件套口径为一百二十七件套（一百二十六件套清除）',
  readme.includes('冒烟一百二十七件套（一百二十六件套清除）') && !readme.includes('冒烟一百一十四件套（一百一十三件套清' + '除）'));
...
ok('package.json test 串共 115 件套', testChain === 127, String(testChain));
...
ok('smoke_v2218 的 GAME_VERSION 字面量 pin 已更新为 v22.19', s2218.includes("const GAME_VERSION = 'v22.31';"));
ok('smoke_v2218 的 GAME_VERSION 恒等 pin 已更新为 === v22.19', s2218.includes("GAME_VERSION === 'v22.31'"));
ok('smoke_v2218 的 package.json 件套计数 pin 已更新为 === 115', s2218.includes('testChain === 127'));
ok('smoke_v2217 的 GAME_VERSION 字面量 pin 已更新为 v22.19', s2217.includes("const GAME_VERSION = 'v22.31';"));
ok('smoke_v2217 的 package.json 件套计数 pin 已更新为 === 115', s2217.includes('testChain === 127'));
