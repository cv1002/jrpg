...
ok('data.js GAME_VERSION 字面量已为 v23.12（旧 v23.11 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.16';") && !dataSrc.includes("const GAME_VERSION = 'v23.11';"));
...
ok('CHANGELOG 顶部已追加 v23.12 条目', changelog.startsWith('## v23.16 '));
...
ok('smoke_v2311 的 GAME_VERSION 字面量 pin 已更新为 v23.12', s2311.includes("const GAME_VERSION = 'v23.16';"));
ok('smoke_v2311 的 CHANGELOG 顶 pin 已更新为 ## v23.12',
  s2311.includes("startsWith('## v23.16 "));
