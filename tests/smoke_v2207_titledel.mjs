...
ok('GAME_VERSION 字面量已为 v22.7（本版独占精确锚点）', GAME_VERSION === 'v22.96', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.7', dataSrc.includes("const GAME_VERSION = 'v22.96';"));
...
ok('README 件套口径为一百九十二件套（一百九十一件套清除）',
  readme.includes('冒烟一百九十二件套（一百九十一件套清除）') && !readme.includes('冒烟一百零二件套（一百零一件套清' + '除）'));
