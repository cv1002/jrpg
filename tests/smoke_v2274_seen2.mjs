...
ok('data.js GAME_VERSION 字面量已为 v22.74（旧 v22.73 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.49';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "73';"));
...
ok('CHANGELOG 含 v22.74 条目（顶 pin）', changelog.startsWith('## v23.49 '));
...
ok('smoke_v2273 的 GAME_VERSION 字面量 pin 已更新为 v22.74', s2273.includes("const GAME_VERSION = 'v23.49';"));
ok('smoke_v2273 的 CHANGELOG 顶 pin 已更新为 ## v22.74', s2273.includes("startsWith('## v23.49'") || s2273.includes("startsWith('## v22.78 '"));
