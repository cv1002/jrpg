...
ok('GAME_VERSION 字面量已为 v21.93', GAME_VERSION === 'v21.95', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.93', dataSrc.includes("const GAME_VERSION = 'v21.95';"));
...
ok('README tests 树收录 smoke_v2193_hunt100/smoke_v2194_statuscodex/smoke_v2195_ptime2 且位于串尾（v2195 随新现实由当版冒烟守护）', readme.includes('smoke_v2193_hunt100 + smoke_v2194_statuscodex + smoke_v2195_ptime2（npm test 串跑）'));
ok('README 件套口径为九十一件套（九十件套清除）',
  readme.includes('冒烟九十一件套（九十件套清除）') && !readme.includes('冒烟八十八件套（八十七件套清除）'));
