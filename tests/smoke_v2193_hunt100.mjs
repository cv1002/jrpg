...
ok('GAME_VERSION 字面量已为 v21.93', GAME_VERSION === 'v24.00', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.93', dataSrc.includes("const GAME_VERSION = 'v24.00';"));
...
ok('README 件套口径为二百二十四件套（二百二十三件套清除）',
  readme.includes('冒烟二百二十四件套（二百二十三件套清除）') && !readme.includes('冒烟八十八件套（八十七件套清除）'));
