...
ok('GAME_VERSION 字面量已为 v21.93', GAME_VERSION === 'v21.93', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.93', dataSrc.includes("const GAME_VERSION = 'v21.93';"));
...
ok('README tests 树收录 smoke_v2193_hunt100 且位于串尾', readme.includes('smoke_v2192_travelwarn + smoke_v2193_hunt100（npm test 串跑）'));
ok('README 件套口径为八十九件套（八十八件套清除）',
  readme.includes('冒烟八十九件套（八十八件套清除）') && !readme.includes('冒烟八十八件套（八十七件套清除）'));
