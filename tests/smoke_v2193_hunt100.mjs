...
ok('GAME_VERSION 字面量已为 v21.93', GAME_VERSION === 'v22.39', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.93', dataSrc.includes("const GAME_VERSION = 'v22.39';"));
...
ok('README 件套口径为一百三十五件套（一百三十四件套清除）',
  readme.includes('冒烟一百三十五件套（一百三十四件套清除）') && !readme.includes('冒烟八十八件套（八十七件套清除）'));
