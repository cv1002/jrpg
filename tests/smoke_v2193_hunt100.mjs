...
ok('GAME_VERSION 字面量已为 v21.93', GAME_VERSION === 'v22.71', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.93', dataSrc.includes("const GAME_VERSION = 'v22.71';"));
...
ok('README 件套口径为一百六十七件套（一百六十六件套清除）',
  readme.includes('冒烟一百六十七件套（一百六十六件套清除）') && !readme.includes('冒烟八十八件套（八十七件套清除）'));
