...
ok('GAME_VERSION 字面量已为 v21.93', GAME_VERSION === 'v22.89', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.93', dataSrc.includes("const GAME_VERSION = 'v22.89';"));
ok('data.js 仍保留 v21.92 历史注释（累积注释块，姊妹 pin 不失效）', dataSrc.includes('v21.92 快速旅行目的地等级达标预警'));
ok('data.js 导出 HUNT2_GOAL（export 块落位，v22.64 起 HUNT3_GOAL 相邻）', dataSrc.includes(', HUNT2_GOAL, HUNT3_GOAL, LVL5_GOAL'));
...
ok('README 件套口径为一百八十五件套（一百八十四件套清除）',
  readme.includes('冒烟一百八十五件套（一百八十四件套清除）') && !readme.includes('冒烟八十八件套（八十七件套清除）'));
