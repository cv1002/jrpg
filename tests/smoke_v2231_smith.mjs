...
ok('GAME_VERSION 字面量已为 v22.31（旧 v22.30 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.28';") && !dSrc.includes("const GAME_VERSION = 'v22." + "30';"));
...
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2230.includes("const GAME_VERSION = 'v23.28';"));
...
ok('smoke_v2229 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2229.includes("const GAME_VERSION = 'v23.28';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.31', s2229.includes("GAME_VERSION === 'v23.28'"));
...
ok('smoke_v2228 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2228.includes("const GAME_VERSION = 'v23.28';"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2226.includes("const GAME_VERSION = 'v23.28';"));
