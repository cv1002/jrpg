...
ok('GAME_VERSION 字面量已为 v22.31（旧 v22.30 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.38';") && !dSrc.includes("const GAME_VERSION = 'v22." + "30';"));
...
ok('README tests 树收录 smoke_v2231_smith 且位于串尾', readme.includes('smoke_v2229_metall + smoke_v2230_pausewarn + smoke_v2231_smith + smoke_v2232_travelsup + smoke_v2233_nameflavor + smoke_v2234_innkeeper + smoke_v2235_minimapquest + smoke_v2236_villagelamp + smoke_v2237_minimaplegend + smoke_v2238_starwell（npm test 串跑）'));
...
ok('README 件套口径为一百三十四件套（一百三十三件套清除）',
  readme.includes('冒烟一百三十四件套（一百三十三件套清除）') && !readme.includes('冒烟一百二十六件套（一百二十五件套清' + '除）'));
...
ok('package.json test 串共 127 件套', testChain === 134, String(testChain));
...
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2230.includes("const GAME_VERSION = 'v22.38';"));
...
ok('smoke_v2230 的 package.json 件套计数 pin 已更新为 === 127', s2230.includes('testChain === 134'));
ok('smoke_v2229 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2229.includes("const GAME_VERSION = 'v22.38';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.31', s2229.includes("GAME_VERSION === 'v22.38'"));
...
ok('smoke_v2229 的 package.json 件套计数 pin 已更新为 === 127', s2229.includes('testChain === 134'));
ok('smoke_v2228 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2228.includes("const GAME_VERSION = 'v22.38';"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2226.includes("const GAME_VERSION = 'v22.38';"));
...
ok('smoke_v2225 的 package.json 件套计数 pin 已更新为 === 127', s2225.includes('testChain === 134'));
