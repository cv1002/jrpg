...
ok('GAME_VERSION 字面量已为 v22.31（旧 v22.30 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.90';") && !dSrc.includes("const GAME_VERSION = 'v22." + "30';"));
...
ok('README 件套口径为一百八十六件套（一百八十五件套清除）',
  readme.includes('冒烟一百八十六件套（一百八十五件套清除）') && !readme.includes('冒烟一百二十六件套（一百二十五件套清' + '除）'));
...
ok('package.json test 串共 127 件套', testChain === 186, String(testChain));
...
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2230.includes("const GAME_VERSION = 'v22.90';"));
...
ok('smoke_v2230 的 package.json 件套计数 pin 已更新为 === 127', s2230.includes('testChain === 186'));
ok('smoke_v2229 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2229.includes("const GAME_VERSION = 'v22.90';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.31', s2229.includes("GAME_VERSION === 'v22.90'"));
...
ok('smoke_v2229 的 package.json 件套计数 pin 已更新为 === 127', s2229.includes('testChain === 186'));
ok('smoke_v2228 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2228.includes("const GAME_VERSION = 'v22.90';"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.31', s2226.includes("const GAME_VERSION = 'v22.90';"));
...
ok('smoke_v2225 的 package.json 件套计数 pin 已更新为 === 127', s2225.includes('testChain === 186'));
