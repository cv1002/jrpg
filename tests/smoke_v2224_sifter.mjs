...
ok('GAME_VERSION 字面量已为 v22.24（旧 v22.23 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.51';") && !dSrc.includes("const GAME_VERSION = 'v22." + "23';"));
...
ok('smoke_v2223 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2223.includes("const GAME_VERSION = 'v23.51';"));
ok('smoke_v2223 的 GAME_VERSION 恒等 pin 已更新为 === v22.24', s2223.includes("GAME_VERSION === 'v23.51'"));
...
ok('smoke_v2222 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2222.includes("const GAME_VERSION = 'v23.51';"));
ok('smoke_v2222 的 GAME_VERSION 恒等 pin 已更新为 === v22.24', s2222.includes("GAME_VERSION === 'v23.51'"));
...
ok('smoke_v2221 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2221.includes("const GAME_VERSION = 'v23.51';"));
ok('smoke_v2221 的 GAME_VERSION 恒等 pin 已更新为 === v22.24', s2221.includes("GAME_VERSION === 'v23.51'"));
...
ok('smoke_v2220 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2220.includes("const GAME_VERSION = 'v23.51';"));
ok('smoke_v2220 的 GAME_VERSION 恒等 pin 已更新为 === v22.24', s2220.includes("GAME_VERSION === 'v23.51'"));
...
ok('smoke_v2219 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2219.includes("const GAME_VERSION = 'v23.51';"));
ok('smoke_v2219 的 README 件套 pin 已随新现实更新为二百一十二件套（二百一十一件套清除）',
  s2219.includes('二百一十二件套（二百一十一件套清除）'));
ok('smoke_v2218 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2218.includes("const GAME_VERSION = 'v23.51';"));
