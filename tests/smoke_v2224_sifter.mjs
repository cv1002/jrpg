...
ok('GAME_VERSION 字面量已为 v22.24（旧 v22.23 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.60';") && !dSrc.includes("const GAME_VERSION = 'v22." + "23';"));
...
ok('README 件套口径为一百五十六件套（一百五十五件套清除）',
  readme.includes('冒烟一百五十六件套（一百五十五件套清除）') && !readme.includes('冒烟一百一十九件套（一百一十八件套清' + '除）'));
...
ok('package.json test 串共 120 件套', testChain === 156, String(testChain));
...
ok('smoke_v2223 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2223.includes("const GAME_VERSION = 'v22.60';"));
ok('smoke_v2223 的 GAME_VERSION 恒等 pin 已更新为 === v22.24', s2223.includes("GAME_VERSION === 'v22.60'"));
...
ok('smoke_v2223 的 package.json 件套计数 pin 已更新为 === 120', s2223.includes('testChain === 156'));
ok('smoke_v2223 的 NPC 总数 pin 已随新现实更新为 26（筛砂人落位）', s2223.includes('总数 29'));
ok('smoke_v2222 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2222.includes("const GAME_VERSION = 'v22.60';"));
ok('smoke_v2222 的 GAME_VERSION 恒等 pin 已更新为 === v22.24', s2222.includes("GAME_VERSION === 'v22.60'"));
...
ok('smoke_v2222 的 package.json 件套计数 pin 已更新为 === 120', s2222.includes('testChain === 156'));
ok('smoke_v2222 的 NPC 总数 pin 已随新现实更新为 26（筛砂人落位）', s2222.includes('总数 29'));
ok('smoke_v2221 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2221.includes("const GAME_VERSION = 'v22.60';"));
ok('smoke_v2221 的 GAME_VERSION 恒等 pin 已更新为 === v22.24', s2221.includes("GAME_VERSION === 'v22.60'"));
...
ok('smoke_v2221 的 package.json 件套计数 pin 已更新为 === 120', s2221.includes('testChain === 156'));
ok('smoke_v2221 的 NPC 总数 pin 已随新现实更新为 26（筛砂人落位）', s2221.includes('总数 29'));
ok('smoke_v2220 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2220.includes("const GAME_VERSION = 'v22.60';"));
ok('smoke_v2220 的 GAME_VERSION 恒等 pin 已更新为 === v22.24', s2220.includes("GAME_VERSION === 'v22.60'"));
...
ok('smoke_v2220 的 package.json 件套计数 pin 已更新为 === 120', s2220.includes('testChain === 156'));
ok('smoke_v2220 的 NPC 总数 pin 已随新现实更新为 26（筛砂人落位）', s2220.includes('总数 29'));
ok('smoke_v2219 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2219.includes("const GAME_VERSION = 'v22.60';"));
ok('smoke_v2219 的 README 件套 pin 已随新现实更新为一百五十六件套（一百五十五件套清除）',
  s2219.includes('一百五十六件套（一百五十五件套清除）'));
ok('smoke_v2218 的 GAME_VERSION 字面量 pin 已更新为 v22.24', s2218.includes("const GAME_VERSION = 'v22.60';"));
ok('smoke_v2218 的 package.json 件套计数 pin 已更新为 === 120', s2218.includes('testChain === 156'));
