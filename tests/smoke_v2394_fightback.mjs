...
ok('data.js GAME_VERSION 字面量已为 v23.94（旧 v23.93 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v24.00';") && !dSrc.includes("const GAME_VERSION = 'v23.9" + "3';"));
...
ok('package.json test 串共 218 件套', testChain === 224, String(testChain));
...
ok('README tests 树串尾已延伸至 smoke_v2394_fightback',
  readme.includes('+ smoke_v2393_deadkey + smoke_v2394_fightback + smoke_v2395_shopscroll + smoke_v2396_steelarmor + smoke_v2397_baserow + smoke_v2398_econrow + smoke_v2399_dmgformula + smoke_v2400_trialwarn（npm test 串跑）'));
...
ok('CHANGELOG 顶部已追加 v23.94 条目（重整旗鼓行 P 口径）', changelog.startsWith('## v24.00 '));
