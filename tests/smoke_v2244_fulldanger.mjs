...
ok('GAME_VERSION 字面量已为 v22.44（旧 v22.43 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.63';") && !dSrc.includes("const GAME_VERSION = 'v22.43';"));
...
ok('package.json test 串共 140 件套（含 smoke_v2244_fulldanger）', testChain === 159, String(testChain));
...
ok('smoke_v2243 的 GAME_VERSION 字面量 pin 已更新为 v22.44（旧 v22.43 零残留）',
  s2243.includes("const GAME_VERSION = 'v22.63';") && !s2243.includes("const GAME_VERSION = 'v22.43';"));
ok('smoke_v2243 的 README 件套 pin 已随新现实更新为一百五十九件套（一百五十八件套清除）',
  s2243.includes('一百五十九件套（一百五十八件套清除）'));
ok('smoke_v2243 的 package.json 件套计数 pin 已更新为 === 140', s2243.includes('testChain === 159'));
