...
ok('GAME_VERSION 字面量已为 v22.44（旧 v22.43 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.22';") && !dSrc.includes("const GAME_VERSION = 'v22.43';"));
...
ok('smoke_v2243 的 GAME_VERSION 字面量 pin 已更新为 v22.44（旧 v22.43 零残留）',
  s2243.includes("const GAME_VERSION = 'v23.22';") && !s2243.includes("const GAME_VERSION = 'v22.43';"));
