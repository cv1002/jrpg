...
ok('GAME_VERSION 字面量已为 v22.94（旧 v22.93 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.88';") && !dSrc.includes("const GAME_VERSION = 'v22." + "93';"));
...
ok('CHANGELOG 顶部已追加 v22.94 条目', changelog.startsWith('## v23.88 '));
...
ok('smoke_v2293 的 GAME_VERSION 字面量 pin 已更新为 v22.94（旧 v22.93 零残留）',
  s2293.includes("const GAME_VERSION = 'v23.88';") && !s2293.includes("const GAME_VERSION = 'v22." + "93';"));
...
ok('smoke_v2293 的 CHANGELOG 顶 pin 已更新为 ## v22.95', s2293.includes("startsWith('## v23.88 '"));
