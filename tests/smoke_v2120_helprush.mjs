...
// v21.72 行数 9→10（本页新增「记忆碎片」行，见 smoke_v2172_helpfrag）：仍 ≤10 → sp=34 档不变；
// 末行（终焉之神）基线 80+9*34+1*16=402、其 r[2] 420 不触页脚 452
ok('试炼进阶页 10 行（原 6 行 + v21.23 三 Boss 机制预览 3 行 + v21.72 记忆碎片 1 行，仍 ≤10 保持 sp=34 档）', page3.length === 10, `实际 ${page3.length}`);
