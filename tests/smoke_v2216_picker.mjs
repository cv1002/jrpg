...
ok('GAME_VERSION 字面量已为 v22.16（旧 v22.15 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.86';") && !dSrc.includes("const GAME_VERSION = 'v22." + "15';"));
...
ok('README 件套口径为一百八十二件套（一百八十一件套清除）', readme.includes('冒烟一百八十二件套（一百八十一件套清除）') && !readme.includes('冒烟一百一十一件套（一百一十件套清' + '除）'));
...
ok('package.json test 串共 112 件套', testChain === 182, String(testChain));
...
ok('smoke_v2215 件套 pin 已随新现实更新为一百一十二件套', s2215.includes('一百八十二件套（一百八十一件套清除）'));
ok('smoke_v2215 的 README 树尾 pin 已更新为 + smoke_v2216_picker', s2215.includes('smoke_v2215_tutorvol + smoke_v2216_picker'));
ok('smoke_v2215 的 GAME_VERSION 字面量 pin 已更新为 v22.16', s2215.includes("const GAME_VERSION = 'v22.86';"));
ok('smoke_v2215 的 GAME_VERSION 恒等 pin 已更新为 === v22.16', s2215.includes("GAME_VERSION === 'v22.86'"));
...
ok('smoke_v2214 的 GAME_VERSION 字面量 pin 已更新为 v22.16', s2214.includes("const GAME_VERSION = 'v22.86';"));
ok('smoke_v2213 的 GAME_VERSION 字面量 pin 已更新为 v22.16', s2213.includes("const GAME_VERSION = 'v22.86';"));
ok('smoke_v2213 的 NPC 总数 pin 已随新现实更新为 21（拾菇人落位）', s2213.includes('总数 29'));
ok('smoke_v2212 的 GAME_VERSION 字面量 pin 已更新为 v22.16', s2212.includes("const GAME_VERSION = 'v22.86';"));
ok('smoke_v2211 的 GAME_VERSION 字面量 pin 已更新为 v22.16（防 v22.15 残留）', s2211.includes("const GAME_VERSION = 'v22.86';") && !s2211.includes("const GAME_VERSION = 'v22." + "15';"));
ok('smoke_v2211 的 NPC 总数 pin 已随新现实更新为 21（拾菇人落位）', s2211.includes('总数 29'));
ok('smoke_v2192 的 GAME_VERSION 字面量 pin 已更新为 v22.16', s2192.includes("const GAME_VERSION = 'v22.86';"));
ok('smoke_v2181 的 GAME_VERSION 字面量 pin 已更新为 v22.16', s2181.includes("const GAME_VERSION = 'v22.86';"));
ok('smoke_v2179 的 GAME_VERSION 字面量 pin 已更新为 v22.16', s2179.includes("const GAME_VERSION = 'v22.86';"));
