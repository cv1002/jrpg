...
ok('GAME_VERSION 字面量已为 v22.45（旧 v22.44 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.67';") && !dSrc.includes("const GAME_VERSION = 'v22." + "44';"));
...
ok('CHANGELOG 顶部已追加 v22.45 条目', changelog.startsWith('## v23.67'));
...
ok('smoke_v2244 的 GAME_VERSION 字面量 pin 已更新为 v22.45（旧 v22.44 零残留）',
  s2244.includes("const GAME_VERSION = 'v23.67';") && !s2244.includes("const GAME_VERSION = 'v22." + "44';"));
