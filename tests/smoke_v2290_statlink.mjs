...
ok('data.js GAME_VERSION 字面量为 v22.90', dataSrc.includes("const GAME_VERSION = 'v22.94';"));
...
ok('GAME_VERSION 导出恒等于 v22.90', GAME_VERSION === 'v22.94', GAME_VERSION);
...
ok('README 件套口径为一百九十件套（一百八十九件套清除）且旧 185 口径零残留',
  readme.includes('冒烟一百九十件套（一百八十九件套清除）') && !readme.includes('一百八十五件套（一百八十四件套清' + '除）'));
...
ok('package.json test 串共 186 件套', testChain === 190, String(testChain));
ok('CHANGELOG 含 v22.90 条目（顶 pin）', changelog.startsWith('## v22.94 '));
...
ok('smoke_v2289 的 GAME_VERSION 字面量 pin 已更新为 v22.90', s2289.includes("const GAME_VERSION = 'v22.94';"));
ok('smoke_v2289 的 CHANGELOG 顶 pin 已更新为 ## v22.90', s2289.includes("startsWith('## v22.94 '"));
ok('smoke_v2289 的件套 pin 已更新为一百九十件套（一百八十九件套清除）', s2289.includes('一百九十一件套（一百九十件套清除）'));
ok('smoke_v2289 的 README 串尾 pin 已延伸至 smoke_v2290_statlink',
  s2289.includes('smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog + smoke_v2290_statlink + smoke_v2291_lampguide + smoke_v2292_cavewatch + smoke_v2293_deadsave + smoke_v2294_crystalwatch（npm test 串跑）'));
ok('smoke_v2289 的 package 串尾 pin 已延伸至 smoke_v2290_statlink',
  s2289.includes('node tests/smoke_v2288_scrollhint.mjs && node tests/smoke_v2289_winprog.mjs && node tests/smoke_v2290_statlink.mjs && node tests/smoke_v2291_lampguide.mjs && node tests/smoke_v2292_cavewatch.mjs && node tests/smoke_v2293_deadsave.mjs && node tests/smoke_v2294_crystalwatch.mjs"'));
ok('smoke_v2289 的 testChain pin 已更新为 186', s2289.includes('testChain === 190'));
ok('smoke_v2289 的哨兵 pin 已更新为一百九十件套（一百八十九件套清除）', s2289.includes('一百九十一件套（一百九十件套清除）'));
ok('smoke_v2288 的 GAME_VERSION 字面量 pin 已更新为 v22.90', s2288.includes("const GAME_VERSION = 'v22.94';"));
ok('smoke_v2288 的 testChain pin 已更新为 186', s2288.includes('testChain === 190'));
ok('smoke_v2288 的 哨兵 pin 已更新为一百九十件套（一百八十九件套清除）', s2288.includes('一百九十一件套（一百九十件套清除）'));
ok('smoke_v2288 的 状态/任务日志行 pin 已随 v22.90 口径更新',
  s2288.includes("row('状态') === 'I（页底 J 直达日志）'") &&
  s2288.includes("row('任务日志') === 'J（↑↓ 滚动 · I 直达状态页）'"));
ok('smoke_v2287 的 GAME_VERSION 字面量 pin 已更新为 v22.90', s2287.includes("const GAME_VERSION = 'v22.94';"));
ok('smoke_v2287 的 testChain pin 已更新为 186', s2287.includes('testChain === 190'));
