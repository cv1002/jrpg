...
ok('data.js GAME_VERSION 字面量为 v22.90', dataSrc.includes("const GAME_VERSION = 'v23.68';"));
...
ok('data.js 状态行现为 I（页底 J 任务日志 · C 成就 · B 图鉴）（v23.68 收口三直达）', dataSrc.includes("['状态','I（页底 J 任务日志 · C 成就 · B 图鉴）']"));
...
ok('GAME_VERSION 导出恒等于 v22.90', GAME_VERSION === 'v23.68', GAME_VERSION);
...
ok('index.html 常驻帮助条 I 处补三直达口径（v23.68）', idx.includes('I</kbd>状态（<kbd>J</kbd>日志 · <kbd>C</kbd>成就 · <kbd>B</kbd>图鉴）'));
...
ok('CHANGELOG 含 v22.90 条目（顶 pin）', changelog.startsWith('## v23.68 '));
...
ok('smoke_v2289 的 GAME_VERSION 字面量 pin 已更新为 v22.90', s2289.includes("const GAME_VERSION = 'v23.68';"));
ok('smoke_v2289 的 CHANGELOG 顶 pin 已更新为 ## v22.90', s2289.includes("startsWith('## v23.68 '"));
...
ok('smoke_v2288 的 GAME_VERSION 字面量 pin 已更新为 v22.90', s2288.includes("const GAME_VERSION = 'v23.68';"));
...
ok('smoke_v2287 的 GAME_VERSION 字面量 pin 已更新为 v22.90', s2287.includes("const GAME_VERSION = 'v23.68';"));
