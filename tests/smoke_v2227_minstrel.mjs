...
ok('GAME_VERSION 字面量已为 v22.27（旧 v22.26 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.30';") && !dSrc.includes("const GAME_VERSION = 'v22." + "26';"));
...
ok('NPC_SPOTS 总数 28（既有 27 键 + 琴师 1 键，v22.27 随新现实更新）', Object.keys(NPC_SPOTS).length === 28, Object.keys(NPC_SPOTS).length);
...
ok('README tests 树收录 smoke_v2227_minstrel 且位于串尾', readme.includes('smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('README tests 树尾链完整（v2226_chestprogress 未被新尾吞并，全链连到 smoke_v2227_minstrel）',
  readme.includes('smoke_v2225_stonecarver + smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('README 件套口径为一百二十六件套（一百二十五件套清除）',
  readme.includes('冒烟一百二十六件套（一百二十五件套清除）') && !readme.includes('冒烟一百二十二件套（一百二十一件套清' + '除）'));
...
ok('package.json test 串共 123 件套', testChain === 126, String(testChain));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2226.includes("const GAME_VERSION = 'v22.30';"));
ok('smoke_v2226 的 GAME_VERSION 恒等 pin 已更新为 === v22.27', s2226.includes("GAME_VERSION === 'v22.30'"));
ok('smoke_v2226 的 README 件套 pin 已随新现实更新为一百二十六件套（一百二十五件套清除）',
  s2226.includes('一百二十六件套（一百二十五件套清除）'));
ok('smoke_v2226 的 README 树尾 pin 已更新为 + smoke_v2227_minstrel',
  s2226.includes('smoke_v2225_stonecarver + smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('smoke_v2226 的 package.json 件套计数 pin 已更新为 === 123', s2226.includes('testChain === 126'));
ok('smoke_v2226 的 package.json 串尾 pin 已更新为 + smoke_v2227_minstrel',
  s2226.includes('smoke_v2226_chestprogress.mjs && node tests/smoke_v2227_minstrel.mjs && node tests/smoke_v2228_titlesave.mjs && node tests/smoke_v2229_metall.mjs && node tests/smoke_v2230_pausewarn.mjs"'));
ok('smoke_v2225 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2225.includes("const GAME_VERSION = 'v22.30';"));
ok('smoke_v2225 的 GAME_VERSION 恒等 pin 已更新为 === v22.27', s2225.includes("GAME_VERSION === 'v22.30'"));
ok('smoke_v2225 的 README 件套 pin 已随新现实更新为一百二十六件套（一百二十五件套清除）',
  s2225.includes('一百二十六件套（一百二十五件套清除）'));
ok('smoke_v2225 的 README 树尾 pin 已更新为 + smoke_v2227_minstrel',
  s2225.includes('smoke_v2225_stonecarver + smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('smoke_v2225 的 package.json 件套计数 pin 已更新为 === 123', s2225.includes('testChain === 126'));
ok('smoke_v2225 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2225.includes('总数 28'));
ok('smoke_v2224 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2224.includes("const GAME_VERSION = 'v22.30';"));
ok('smoke_v2224 的 README 件套 pin 已随新现实更新为一百二十六件套（一百二十五件套清除）',
  s2224.includes('一百二十六件套（一百二十五件套清除）'));
ok('smoke_v2224 的 README 树尾 pin 已更新为 + smoke_v2227_minstrel',
  s2224.includes('smoke_v2224_sifter + smoke_v2225_stonecarver + smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('smoke_v2224 的 package.json 件套计数 pin 已更新为 === 123', s2224.includes('testChain === 126'));
ok('smoke_v2224 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2224.includes('总数 28'));
ok('smoke_v2223 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2223.includes("const GAME_VERSION = 'v22.30';"));
ok('smoke_v2223 的 README 件套 pin 已随新现实更新为一百二十六件套（一百二十五件套清除）',
  s2223.includes('一百二十六件套（一百二十五件套清除）'));
ok('smoke_v2223 的 README 树尾 pin 已更新为 + smoke_v2227_minstrel',
  s2223.includes('smoke_v2223_lampman + smoke_v2224_sifter + smoke_v2225_stonecarver + smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('smoke_v2223 的 package.json 件套计数 pin 已更新为 === 123', s2223.includes('testChain === 126'));
ok('smoke_v2223 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2223.includes('总数 28'));
ok('smoke_v2222 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2222.includes("const GAME_VERSION = 'v22.30';"));
ok('smoke_v2222 的 README 件套 pin 已随新现实更新为一百二十六件套（一百二十五件套清除）',
  s2222.includes('一百二十六件套（一百二十五件套清除）'));
ok('smoke_v2222 的 README 树尾 pin 已更新为 + smoke_v2227_minstrel',
  s2222.includes('smoke_v2222_peddler + smoke_v2223_lampman + smoke_v2224_sifter + smoke_v2225_stonecarver + smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('smoke_v2222 的 package.json 件套计数 pin 已更新为 === 123', s2222.includes('testChain === 126'));
ok('smoke_v2222 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2222.includes('总数 28'));
ok('smoke_v2221 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2221.includes("const GAME_VERSION = 'v22.30';"));
ok('smoke_v2221 的 README 件套 pin 已随新现实更新为一百二十六件套（一百二十五件套清除）',
  s2221.includes('一百二十六件套（一百二十五件套清除）'));
ok('smoke_v2221 的 README 树尾 pin 已更新为 + smoke_v2227_minstrel',
  s2221.includes('smoke_v2221_wanderer + smoke_v2222_peddler + smoke_v2223_lampman + smoke_v2224_sifter + smoke_v2225_stonecarver + smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('smoke_v2221 的 package.json 件套计数 pin 已更新为 === 123', s2221.includes('testChain === 126'));
ok('smoke_v2221 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2221.includes('总数 28'));
ok('smoke_v2220 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2220.includes("const GAME_VERSION = 'v22.30';"));
ok('smoke_v2220 的 README 件套 pin 已随新现实更新为一百二十六件套（一百二十五件套清除）',
  s2220.includes('一百二十六件套（一百二十五件套清除）'));
ok('smoke_v2220 的 README 树尾 pin 已更新为 + smoke_v2227_minstrel',
  s2220.includes('smoke_v2220_hearer + smoke_v2221_wanderer + smoke_v2222_peddler + smoke_v2223_lampman + smoke_v2224_sifter + smoke_v2225_stonecarver + smoke_v2226_chestprogress + smoke_v2227_minstrel + smoke_v2228_titlesave + smoke_v2229_metall + smoke_v2230_pausewarn（npm test 串跑）'));
ok('smoke_v2220 的 package.json 件套计数 pin 已更新为 === 123', s2220.includes('testChain === 126'));
ok('smoke_v2220 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2220.includes('总数 28'));
ok('smoke_v2216 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2216.includes('总数 28'));
ok('smoke_v2213 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2213.includes('总数 28'));
ok('smoke_v2211 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2211.includes('总数 28'));
