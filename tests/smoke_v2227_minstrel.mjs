...
ok('GAME_VERSION 字面量已为 v22.27（旧 v22.26 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.65';") && !dSrc.includes("const GAME_VERSION = 'v22." + "26';"));
...
ok('README 件套口径为一百六十一件套（一百六十件套清除）',
  readme.includes('冒烟一百六十一件套（一百六十件套清除）') && !readme.includes('冒烟一百二十二件套（一百二十一件套清' + '除）'));
...
ok('package.json test 串共 123 件套', testChain === 161, String(testChain));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2226.includes("const GAME_VERSION = 'v22.65';"));
ok('smoke_v2226 的 GAME_VERSION 恒等 pin 已更新为 === v22.27', s2226.includes("GAME_VERSION === 'v22.65'"));
ok('smoke_v2226 的 README 件套 pin 已随新现实更新为一百六十一件套（一百六十件套清除）',
  s2226.includes('一百六十一件套（一百六十件套清除）'));
...
ok('smoke_v2226 的 package.json 件套计数 pin 已更新为 === 123', s2226.includes('testChain === 161'));
...
ok('smoke_v2225 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2225.includes("const GAME_VERSION = 'v22.65';"));
ok('smoke_v2225 的 GAME_VERSION 恒等 pin 已更新为 === v22.27', s2225.includes("GAME_VERSION === 'v22.65'"));
ok('smoke_v2225 的 README 件套 pin 已随新现实更新为一百六十一件套（一百六十件套清除）',
  s2225.includes('一百六十一件套（一百六十件套清除）'));
...
ok('smoke_v2225 的 package.json 件套计数 pin 已更新为 === 123', s2225.includes('testChain === 161'));
ok('smoke_v2225 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2225.includes('总数 29'));
ok('smoke_v2224 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2224.includes("const GAME_VERSION = 'v22.65';"));
...
ok('smoke_v2224 的 package.json 件套计数 pin 已更新为 === 123', s2224.includes('testChain === 161'));
ok('smoke_v2224 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2224.includes('总数 29'));
ok('smoke_v2223 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2223.includes("const GAME_VERSION = 'v22.65';"));
...
ok('smoke_v2223 的 package.json 件套计数 pin 已更新为 === 123', s2223.includes('testChain === 161'));
ok('smoke_v2223 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2223.includes('总数 29'));
ok('smoke_v2222 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2222.includes("const GAME_VERSION = 'v22.65';"));
...
ok('smoke_v2222 的 package.json 件套计数 pin 已更新为 === 123', s2222.includes('testChain === 161'));
ok('smoke_v2222 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2222.includes('总数 29'));
ok('smoke_v2221 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2221.includes("const GAME_VERSION = 'v22.65';"));
...
ok('smoke_v2221 的 package.json 件套计数 pin 已更新为 === 123', s2221.includes('testChain === 161'));
ok('smoke_v2221 的 NPC 总数 pin 已随新现实更新为 28（琴师落位）', s2221.includes('总数 29'));
ok('smoke_v2220 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2220.includes("const GAME_VERSION = 'v22.65';"));
...
ok('smoke_v2220 的 package.json 件套计数 pin 已更新为 === 123', s2220.includes('testChain === 161'));
