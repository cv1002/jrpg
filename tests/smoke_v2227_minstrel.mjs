...
ok('GAME_VERSION 字面量已为 v22.27（旧 v22.26 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.80';") && !dSrc.includes("const GAME_VERSION = 'v22." + "26';"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2226.includes("const GAME_VERSION = 'v23.80';"));
ok('smoke_v2226 的 GAME_VERSION 恒等 pin 已更新为 === v22.27', s2226.includes("GAME_VERSION === 'v23.80'"));
...
ok('smoke_v2225 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2225.includes("const GAME_VERSION = 'v23.80';"));
ok('smoke_v2225 的 GAME_VERSION 恒等 pin 已更新为 === v22.27', s2225.includes("GAME_VERSION === 'v23.80'"));
...
ok('smoke_v2224 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2224.includes("const GAME_VERSION = 'v23.80';"));
...
ok('smoke_v2223 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2223.includes("const GAME_VERSION = 'v23.80';"));
...
ok('smoke_v2222 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2222.includes("const GAME_VERSION = 'v23.80';"));
...
ok('smoke_v2221 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2221.includes("const GAME_VERSION = 'v23.80';"));
...
ok('smoke_v2220 的 GAME_VERSION 字面量 pin 已更新为 v22.27', s2220.includes("const GAME_VERSION = 'v23.80';"));
