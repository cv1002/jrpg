...
// 同步 + 姊妹件套 pin（v2184..v2176 八十一件套 / v2184·v2183·v2182·v2181·v2179 GAME_VERSION v21.85）
// 随新现实更新。
...
ok('data.js GAME_VERSION 字面量已更新为 v21.85', dSrc.includes("const GAME_VERSION = 'v21.85';"));
