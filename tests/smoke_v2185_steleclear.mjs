...
ok('GAME_VERSION 格式合法且已越过 v21.84', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 90)), GAME_VERSION);
ok('data.js 含 v21.85 注释（试炼碑通关后状态如实分档说明）', dSrc.includes('v21.85 体验打磨'));
ok('data.js GAME_VERSION 字面量已更新为 v21.85', dSrc.includes("const GAME_VERSION = 'v22.90';"));
