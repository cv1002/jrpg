...
ok('data.js GAME_VERSION 字面量已为 v23.06（旧 v23.05 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.74';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "05';"));
...
ok('CHANGELOG 顶部已追加 v23.06 条目', changelog.startsWith('## v23.74 '));
...
ok('smoke_v2305 的 GAME_VERSION 字面量 pin 已更新为 v23.06', s2305.includes("const GAME_VERSION = 'v23.74';"));
ok('smoke_v2305 的 CHANGELOG 顶 pin 已更新为 ## v23.06',
  s2305.includes("startsWith('## v23.74 "));
