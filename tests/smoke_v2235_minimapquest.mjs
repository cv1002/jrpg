...
ok('GAME_VERSION 字面量已为 v22.35（旧 v22.34 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.78';") && !dSrc.includes("const GAME_VERSION = 'v22." + "34';"));
...
ok('README 件套口径为二百一十四件套（二百一十三件套清除）',
  readme.includes('冒烟二百一十四件套（二百一十三件套清除）') && !readme.includes('冒烟一百三十件套（一百二十九件套清' + '除）'));
...
ok('package.json test 串共 131 件套', testChain === 214, String(testChain));
...
ok('smoke_v2234 的 GAME_VERSION 字面量 pin 已更新为 v22.35', s2234.includes("const GAME_VERSION = 'v23.78';"));
ok('smoke_v2234 的 GAME_VERSION 恒等 pin 已更新为 === v22.35', s2234.includes("GAME_VERSION === 'v23.78'"));
...
ok('smoke_v2234 的 package.json 件套计数 pin 已更新为 === 131', s2234.includes('testChain === 214'));
ok('smoke_v2233 的 GAME_VERSION 字面量 pin 已更新为 v22.35', s2233.includes("const GAME_VERSION = 'v23.78';"));
ok('smoke_v2232 的 GAME_VERSION 恒等 pin 已更新为 === v22.35', s2232.includes("GAME_VERSION === 'v23.78'"));
...
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.35', s2230.includes("const GAME_VERSION = 'v23.78';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.35', s2229.includes("GAME_VERSION === 'v23.78'"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.35', s2226.includes("const GAME_VERSION = 'v23.78';"));
// 旧代 v22.34 pin 全库零残留
