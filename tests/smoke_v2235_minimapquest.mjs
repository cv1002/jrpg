...
ok('GAME_VERSION 字面量已为 v22.35（旧 v22.34 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.92';") && !dSrc.includes("const GAME_VERSION = 'v22." + "34';"));
...
// 档 B：任务全 done——全部 NPC 格回米色、零金光（v23.57 起 village 第五位任务委托人酿药师入列，side_snake 补 done）
const capB = captureMinimapCells({ side_mushroom: 'done', side_stone: 'done', side_grain: 'done', side_wolf: 'done', side_snake: 'done' });
...
ok('README 件套口径为二百一十六件套（二百一十五件套清除）',
  readme.includes('冒烟二百一十六件套（二百一十五件套清除）') && !readme.includes('冒烟一百三十件套（一百二十九件套清' + '除）'));
...
ok('package.json test 串共 131 件套', testChain === 216, String(testChain));
...
ok('smoke_v2234 的 GAME_VERSION 字面量 pin 已更新为 v22.35', s2234.includes("const GAME_VERSION = 'v23.92';"));
ok('smoke_v2234 的 GAME_VERSION 恒等 pin 已更新为 === v22.35', s2234.includes("GAME_VERSION === 'v23.92'"));
...
ok('smoke_v2234 的 package.json 件套计数 pin 已更新为 === 131', s2234.includes('testChain === 216'));
ok('smoke_v2233 的 GAME_VERSION 字面量 pin 已更新为 v22.35', s2233.includes("const GAME_VERSION = 'v23.92';"));
ok('smoke_v2232 的 GAME_VERSION 恒等 pin 已更新为 === v22.35', s2232.includes("GAME_VERSION === 'v23.92'"));
...
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.35', s2230.includes("const GAME_VERSION = 'v23.92';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.35', s2229.includes("GAME_VERSION === 'v23.92'"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.35', s2226.includes("const GAME_VERSION = 'v23.92';"));
// 旧代 v22.34 pin 全库零残留
