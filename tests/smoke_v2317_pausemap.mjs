...
ok('GAME_VERSION 字面量已为 v23.79（旧 v23.76 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.97';") && !dSrc.includes("const GAME_VERSION = 'v23.7" + "6';"));
...
ok('package.json test 串共 213 件套', testChain === 221, String(testChain));
...
ok('README 件套口径为二百二十一件套（二百二十件套清除）',
  readme.includes('冒烟二百二十一件套（二百二十件套清除）') && !readme.includes('冒烟二百一十二件套（二百一十一件套清' + '除）'));
...
ok('CHANGELOG 顶部已追加 v23.79 条目（暂停菜单当前所在地）', changelog.startsWith('## v23.97 '));
