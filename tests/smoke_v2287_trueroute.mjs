...
ok('data.js GAME_VERSION 字面量为 v22.87', dataSrc.includes("const GAME_VERSION = 'v23.88'"));
...
ok('CHANGELOG 含 v22.87 条目（顶 pin）', changelog.startsWith('## v23.88 '));
...
ok('smoke_v2286 的 GAME_VERSION 字面量 pin 已更新为 v22.87', s2286.includes("const GAME_VERSION = 'v23.88';"));
ok('smoke_v2286 的 CHANGELOG 顶 pin 已更新为 ## v22.87', s2286.includes("startsWith('## v23.88 '"));
...
ok('smoke_v2285 的 GAME_VERSION 字面量 pin 已更新为 v22.87', s2285.includes("const GAME_VERSION = 'v23.88';"));
