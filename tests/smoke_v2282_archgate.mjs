...
ok('data.js GAME_VERSION 字面量为 v22.82', dataSrc.includes("const GAME_VERSION = 'v23.56'"));
...
ok('CHANGELOG 含 v22.82 条目（顶 pin）', changelog.startsWith('## v23.56 '));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.82', s2281.includes("const GAME_VERSION = 'v23.56';"));
ok('smoke_v2281 的 CHANGELOG 顶 pin 已更新为 ## v22.82', s2281.includes("startsWith('## v23.56'"));
