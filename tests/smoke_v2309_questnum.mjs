...
ok('data.js GAME_VERSION 字面量已为 v23.35（旧 v23.33 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.57';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "33';"));
...
ok('data.js 树精的菌库字面量逐字（reward:{ gold:70, item:1 } / const TREE_GOAL = 3; / export 落位（WOLF_GOAL 与 GRAIN_GOAL·TREE_GOAL 相邻，v23.57 起 SNAKE_GOAL 并列 WOLF_GOAL 之后；v23.54 起 DEFLECT_GOAL 后并列 CHARGE_GOAL））',
  dataSrc.includes('reward:{ gold:70, item:1 }') && dataSrc.includes('const TREE_GOAL = 3;') && dataSrc.includes('GRAIN_GOAL, WOLF_GOAL, SNAKE_GOAL, TREE_GOAL, DEFLECT_GOAL, CHARGE_GOAL, MUSHROOM_PRICE'));
...
ok('CHANGELOG 顶部已追加 v23.35 条目', changelog.startsWith('## v23.57 '));
...
ok('smoke_v2308 的 GAME_VERSION 字面量 pin 已更新为 v23.35', s2308.includes("const GAME_VERSION = 'v23.57';"));
ok('smoke_v2308 的 CHANGELOG 顶 pin 已更新为 ## v23.36',
  s2308.includes("startsWith('## v23.57 "));
