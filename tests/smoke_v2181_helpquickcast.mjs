...
ok('data.js GAME_VERSION 字面量已更新为 v21.82', dataSrc.includes("const GAME_VERSION = 'v22.36';"));
...
ok('README 件套口径已更新为一百三十二件套（一百三十一件套清除）',
  readme.includes('一百三十二件套（一百三十一件套清除）') && !readme.includes('七十六件套（七十五件套清除）'));
...
ok('smoke_v2180 的 README 件套 pin 已随新现实更新为一百三十二件套（一百三十一件套清除）',
  s2180.includes('一百三十二件套（一百三十一件套清除）') && !s2180.includes('七十六件套（七十五件套清除）'));
ok('smoke_v2179 的 README 件套 pin 已随新现实更新为一百三十二件套（一百三十一件套清除）',
  s2179.includes('一百三十二件套（一百三十一件套清除）') && !s2179.includes('七十六件套（七十五件套清除）'));
ok('smoke_v2179 的 GAME_VERSION 字面量 pin 已随新现实更新为 v21.84',
  s2179.includes("const GAME_VERSION = 'v22.36';"));
ok('smoke_v2178 的 README 件套 pin 已随新现实更新为一百三十二件套（一百三十一件套清除）',
  s2178.includes('一百三十二件套（一百三十一件套清除）') && !s2178.includes('七十六件套（七十五件套清除）'));
ok('smoke_v2177 的 README 件套 pin 已随新现实更新为一百三十二件套（一百三十一件套清除）',
  s2177.includes('一百三十二件套（一百三十一件套清除）') && !s2177.includes('七十六件套（七十五件套清除）'));
ok('smoke_v2176 的 README 件套 pin 已随新现实更新为一百三十二件套（一百三十一件套清除）',
  s2176.includes('一百三十二件套（一百三十一件套清除）') && !s2176.includes('七十六件套（七十五件套清除）'));
