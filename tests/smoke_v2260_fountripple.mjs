...
ok('GAME_VERSION 字面量已为 v22.60（旧 v22.59 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.17';") && !dSrc.includes("const GAME_VERSION = 'v22." + "59';"));
...
ok('smoke_v2259 的 GAME_VERSION 字面量 pin 已更新为 v22.60', s2259.includes("const GAME_VERSION = 'v23.17';"));
...
ok('smoke_v2258 的 GAME_VERSION 字面量 pin 已更新为 v22.60', s2258.includes("const GAME_VERSION = 'v23.17';"));
ok('smoke_v2257 的 GAME_VERSION 字面量 pin 已更新为 v22.60', s2257.includes("const GAME_VERSION = 'v23.17';"));
ok('smoke_v2256 的 GAME_VERSION 字面量 pin 已更新为 v22.60', s2256.includes("const GAME_VERSION = 'v23.17';"));
ok('smoke_v2255/v2254/v2253/v2252 的 GAME_VERSION 字面量 pin 已更新为 v22.60',
  s2255.includes("const GAME_VERSION = 'v23.17';") && s2254.includes("const GAME_VERSION = 'v23.17';") &&
  s2253.includes("const GAME_VERSION = 'v23.17';") && s2252.includes("const GAME_VERSION = 'v23.17';"));
