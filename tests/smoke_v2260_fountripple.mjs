...
ok('GAME_VERSION 字面量已为 v22.60（旧 v22.59 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.74';") && !dSrc.includes("const GAME_VERSION = 'v22." + "59';"));
...
ok('README 件套口径为一百七十件套（一百六十九件套清除）且旧 155 口径零残留',
  readme.includes('冒烟一百七十件套（一百六十九件套清除）') && !readme.includes('一百五十五件套（一百五十四件套清' + '除）'));
...
ok('package.json test 串共 156 件套', testChain === 170, String(testChain));
...
ok('smoke_v2259 的 GAME_VERSION 字面量 pin 已更新为 v22.60', s2259.includes("const GAME_VERSION = 'v22.74';"));
...
ok('smoke_v2259 的 package.json 件套计数 pin 已更新为 === 156', s2259.includes('testChain === 170'));
ok('smoke_v2259 的 CHANGELOG 顶 pin 已更新为 ## v22.60', s2259.includes("startsWith('## v22.74')"));
...
ok('smoke_v2258 的 GAME_VERSION 字面量 pin 已更新为 v22.60', s2258.includes("const GAME_VERSION = 'v22.74';"));
ok('smoke_v2257 的 GAME_VERSION 字面量 pin 已更新为 v22.60', s2257.includes("const GAME_VERSION = 'v22.74';"));
ok('smoke_v2256 的 GAME_VERSION 字面量 pin 已更新为 v22.60', s2256.includes("const GAME_VERSION = 'v22.74';"));
ok('smoke_v2255/v2254/v2253/v2252 的 GAME_VERSION 字面量 pin 已更新为 v22.60',
  s2255.includes("const GAME_VERSION = 'v22.74';") && s2254.includes("const GAME_VERSION = 'v22.74';") &&
  s2253.includes("const GAME_VERSION = 'v22.74';") && s2252.includes("const GAME_VERSION = 'v22.74';"));
...
ok('v2143-45「件套守护领先一位」哨兵链已推进至 157（一百七十一件套（一百七十件套清除））',
