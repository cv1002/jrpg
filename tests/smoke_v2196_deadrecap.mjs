...
ok('GAME_VERSION 字面量已为 v21.96', GAME_VERSION === 'v22.50', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.96', dataSrc.includes("const GAME_VERSION = 'v22.50';"));
...
ok('README 件套口径为一百四十六件套（一百四十五件套清除）',
  readme.includes('冒烟一百四十六件套（一百四十五件套清除）') && !readme.includes('冒烟九十件套（八十九件套清除）'));
