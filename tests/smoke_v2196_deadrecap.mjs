...
ok('GAME_VERSION 字面量已为 v21.96', GAME_VERSION === 'v21.96', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.96', dataSrc.includes("const GAME_VERSION = 'v21.96';"));
...
ok('README tests 树收录 smoke_v2196_deadrecap 且位于串尾（v2196 随新现实由当版冒烟守护）', readme.includes('smoke_v2195_ptime2 + smoke_v2196_deadrecap（npm test 串跑）'));
...
for (const nm of ['smoke_v2195_ptime2.mjs', 'smoke_v2194_statuscodex.mjs', 'smoke_v2193_hunt100.mjs', 'smoke_v2192_travelwarn.mjs']) {
  ...
  ok(`${nm} 的 GAME_VERSION 恒等 pin（===）已随新现实更新为 v21.96`,
    src.includes("GAME_VERSION === 'v21.96'"));
}
