...
ok('GAME_VERSION 字面量已为 v21.96', GAME_VERSION === 'v22.89', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.96', dataSrc.includes("const GAME_VERSION = 'v22.89';"));
...
ok('README 系统清单「战败复盘」段补收集四件套口径（另补**收集进度四件套**）',
  readme.includes('另补**收集进度四件套**') && readme.includes('🏆 成就 N/M · 📕 图鉴 N/M · 📦 宝箱 N/M'));
