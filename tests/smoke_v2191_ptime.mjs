...
ok('GAME_VERSION 格式合法且已越过 v21.90', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 97)), GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.91', dataSrc.includes("const GAME_VERSION = 'v22.97';"));
