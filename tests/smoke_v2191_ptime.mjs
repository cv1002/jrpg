...
ok('data.js GAME_VERSION 字面量已更新为 v21.91', dataSrc.includes("const GAME_VERSION = 'v21.95';"));
ok('data.js 导出 PLAY_TIME_GOAL（export 块落位；v21.95 起 PLAY_TIME2_GOAL 随其后，当版冒烟守护）', dataSrc.includes(', PLAY_TIME_GOAL, PLAY_TIME2_GOAL, PERFECTION_GOLD'));
...
for (const nm of achFiles) {
  ...
  ok(`${nm} 的 README 成就 pin 已随新现实更新（33 项 pin 零残留，34 项双处落位）`,
    src.includes("readme.includes('成就一览（全部 35 项进度'") && !src.includes('**33 项成就**'));
}
