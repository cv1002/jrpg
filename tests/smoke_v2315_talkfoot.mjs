...
ok('data.js GAME_VERSION 字面量已为 v23.15（旧 v23.14 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.67';") && !dataSrc.includes("const GAME_VERSION = 'v23.14';"));
...
ok('CHANGELOG 顶部已追加 v23.15 条目', changelog.startsWith('## v23.67 '));
...
ok('smoke_v2314 的 GAME_VERSION 字面量 pin 已更新为 v23.15', s2314.includes("const GAME_VERSION = 'v23.67';"));
ok('smoke_v2314 的 CHANGELOG 顶 pin 已更新为 ## v23.27', s2314.includes("startsWith('## v23.67 "));
