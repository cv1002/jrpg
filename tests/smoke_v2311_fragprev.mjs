...
ok('data.js GAME_VERSION 字面量已为 v23.11（旧 v23.10 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.63';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "10';"));
...
ok('CHANGELOG 顶部已追加 v23.11 条目', changelog.startsWith('## v23.63 '));
...
ok('smoke_v2310 的 GAME_VERSION 字面量 pin 已更新为 v23.11', s2310.includes("const GAME_VERSION = 'v23.63';"));
ok('smoke_v2310 的 CHANGELOG 顶 pin 已更新为 ## v23.12',
  s2310.includes("startsWith('## v23.63 "));
