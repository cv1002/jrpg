...
ok('GAME_VERSION 字面量已为 v22.6（本版独占精确锚点）', GAME_VERSION === 'v22.32', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.6', dataSrc.includes("const GAME_VERSION = 'v22.32';"));
...
ok('README 件套口径为一百二十八件套（一百二十七件套清除）',
  readme.includes('冒烟一百二十八件套（一百二十七件套清除）') && !readme.includes('冒烟一百零一件套（一百件套清' + '除）'));
