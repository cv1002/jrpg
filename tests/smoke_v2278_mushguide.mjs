...
ok('README 件套口径为一百九十三件套（一百九十二件套清除）且旧 173 口径零残留',
...
ok('package.json test 串共 174 件套', testChain === 193, String(testChain));
...
ok('smoke_v2276 的 GAME_VERSION 字面量 pin 已更新为 v22.79', s2276.includes("const GAME_VERSION = 'v22.97';"));
ok('smoke_v2276 的 CHANGELOG 顶 pin 已更新为 ## v22.78', s2276.includes("startsWith('## v22.97'"));
ok('smoke_v2276 的件套 pin 已更新为一百九十三件套（一百九十二件套清除）', s2276.includes('一百九十四件套（一百九十三件套清除）'));
