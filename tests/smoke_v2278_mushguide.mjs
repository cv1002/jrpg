...
ok('README 件套口径为二百零七件套（二百零六件套清除）且旧 173 口径零残留',
...
ok('package.json test 串共 174 件套', testChain === 207, String(testChain));
...
ok('smoke_v2276 的 GAME_VERSION 字面量 pin 已更新为 v22.79', s2276.includes("const GAME_VERSION = 'v23.11';"));
ok('smoke_v2276 的 CHANGELOG 顶 pin 已更新为 ## v22.78', s2276.includes("startsWith('## v23.11'"));
ok('smoke_v2276 的件套 pin 已更新为二百零七件套（二百零六件套清除）', s2276.includes('二百零七件套（二百零六件套清除）'));
