...
ok('GAME_VERSION 字面量已为 v22.3', GAME_VERSION === 'v22.67', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.3', dataSrc.includes("const GAME_VERSION = 'v22.67';"));
