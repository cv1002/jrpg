...
ok('GAME_VERSION 字面量已为 v22.51（旧 v22.50 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.18';") && !dSrc.includes("const GAME_VERSION = 'v22." + "50';"));
...
ok('CHANGELOG 顶部已追加 v22.51 条目', changelog.startsWith('## v23.18'));
...
ok('smoke_v2250 的 GAME_VERSION 字面量 pin 已更新为 v22.51（旧 v22.50 零残留）',
  s2250.includes("const GAME_VERSION = 'v23.18';") && !s2250.includes("const GAME_VERSION = 'v22." + "50';"));
