...
ok('data.js GAME_VERSION 字面量已为 v23.13（旧 v23.12 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.24';") && !dataSrc.includes("const GAME_VERSION = 'v23.12';"));
...
ok('CHANGELOG 顶部已追加 v23.13 条目', changelog.startsWith('## v23.24 '));
...
ok('smoke_v2312 的 GAME_VERSION 字面量 pin 已更新为 v23.13', s2312.includes("const GAME_VERSION = 'v23.24';"));
ok('smoke_v2312 的 CHANGELOG 顶 pin 已更新为 ## v23.13',
  s2312.includes("startsWith('## v23.24 "));
