...
ok('data.js GAME_VERSION 字面量已为 v23.13（旧 v23.12 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.12';"));
...
ok('data.js GAME_VERSION 已级联 v23.40（旧 v23.38 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.38';"));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.40', dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.35';"));
...
ok('CHANGELOG 顶部已追加 v23.40 条目', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.41（旧 v23.40 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.40';"));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.42（旧 v23.41 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.41';"));
...
ok('CHANGELOG 顶部已追加 v23.42 条目（新支线夜路的狼嚎）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.43（旧 v23.42 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.42';"));
...
ok('CHANGELOG 顶部已追加 v23.43 条目（暴击专属上扬音）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.44（旧 v23.43 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.43';"));
...
ok('CHANGELOG 顶部已追加 v23.44 条目（指令栏 [5]防御 回蓝/反击 预览补全）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.45（旧 v23.44 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.44';"));
...
ok('CHANGELOG 顶部已追加 v23.45 条目（Boss/试炼战专属战斗 BGM）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.46（旧 v23.45 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.45';"));
...
ok('CHANGELOG 顶部已追加 v23.46 条目（真身变身专属音效）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.47（旧 v23.46 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.46';"));
...
ok('CHANGELOG 顶部已追加 v23.47 条目（蓄力专属音效）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.48（旧 v23.47 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.47';"));
...
ok('CHANGELOG 顶部已追加 v23.48 条目（敌方暗影回血专属音效）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.49（旧 v23.48 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.48';"));
...
ok('CHANGELOG 顶部已追加 v23.49 条目（宝箱开启专属音效）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.50（旧 v23.49 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.49';"));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.52（旧 v23.50 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.50';"));
...
ok('CHANGELOG 顶部已追加 v23.51 条目（敌方石甲专属音效）', changelog.startsWith('## v23.83 '));
...
ok('CHANGELOG 顶部已追加 v23.41 条目', changelog.startsWith('## v23.83 '));
...
ok('smoke_v2312 的 GAME_VERSION 字面量 pin 已更新为 v23.13', s2312.includes("const GAME_VERSION = 'v23.83';"));
ok('smoke_v2312 的 CHANGELOG 顶 pin 已更新为 ## v23.13',
  s2312.includes("startsWith('## v23.83 "));
...
ok('CHANGELOG 顶部已追加 v23.52 条目（improve-plan 落地状态对齐）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.53（旧 v23.52 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.52';"));
...
ok('CHANGELOG 顶部已追加 v23.53 条目（精英「重击」逐招预判补全）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.54（旧 v23.53 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.53';"));
...
ok('CHANGELOG 顶部已追加 v23.54 条目（新成就蓄势待发）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.55（旧 v23.54 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.54';"));
...
ok('CHANGELOG 顶部已追加 v23.55 条目（Lv12 终章新技能灯焰长明）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.56（旧 v23.55 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.55';"));
...
ok('CHANGELOG 顶部已追加 v23.56 条目（试炼战报补经验）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.57（旧 v23.56 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.56';"));
...
ok('CHANGELOG 顶部已追加 v23.57 条目（新支线蛇影的药引）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.58（旧 v23.57 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.57';"));
...
ok('CHANGELOG 顶部已追加 v23.58 条目（潮灯镇行酿药师指针）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.59（旧 v23.58 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.59';"));
...
ok('CHANGELOG 顶部已追加 v23.59 条目（记忆碎片拾取音效归位）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.61（旧 v23.60 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.60';"));
...
ok('CHANGELOG 顶部已追加 v23.61 条目（状态页技能节头计数）', changelog.startsWith('## v23.83 '));
...
// 有进度、图鉴行此前查无一行，现按 quests.questKillProg 单一数据源在行第二行追加「 · 📜 支线 N/M」）——
{
  ...
  ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.62（旧 v23.61 字面量零残留）',
    dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.61';"));
  ...
  ok('CHANGELOG 顶部已追加 v23.62 条目（记忆图鉴行讨伐支线进度角标）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.63（旧 v23.62 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.62';"));
...
ok('CHANGELOG 顶部已追加 v23.63 条目（新成就暴击如雨）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.64（旧 v23.63 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.63';"));
...
ok('CHANGELOG 顶部已追加 v23.64 条目（新成就熟能生巧）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.65（旧 v23.64 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.64';"));
...
ok('CHANGELOG 顶部已追加 v23.65 条目（新成就走为上计）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.66（旧 v23.65 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.65';"));
...
ok('CHANGELOG 顶部已追加 v23.66 条目（新成就药到病除）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已随新现实级联为 v23.67（旧 v23.66 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.66';"));
...
ok('CHANGELOG 顶部已追加 v23.67 条目（新成就千锤百炼）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.68（旧 v23.67 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.67';"));
...
ok('CHANGELOG 顶部已追加 v23.69 条目（状态页 C/B 直达）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.69（旧 v23.68 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.68';"));
...
ok('CHANGELOG 顶部已追加 v23.69 条目（四收集页互切网格）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.71（旧 v23.69 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.69';"));
...
ok('CHANGELOG 顶部已追加 v23.70 条目（帮助页补四收集页直达，当前顶 pin v23.71）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.71（旧 v23.70 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.70';"));
...
ok('CHANGELOG 顶部已追加 v23.71 条目（收集页补 H 帮助直达）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.72（旧 v23.71 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.71';"));
...
ok('CHANGELOG 顶部已追加 v23.72 条目（新成就渴饮甘露）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.73（旧 v23.72 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.72';"));
...
ok('CHANGELOG 顶部已追加 v23.73 条目（新成就夜宿灯下）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.76（旧 v23.73 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.73';"));
...
ok('CHANGELOG 顶部已追加 v23.75 条目（新成就一掷千金）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.76（旧 v23.74 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.74';"));
...
ok('CHANGELOG 顶部已追加 v23.75 条目（新成就行者无疆）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.76（旧 v23.75 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.75';"));
...
ok('CHANGELOG 顶部已追加 v23.76 条目（新成就千里之行）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.80（旧 v23.79 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.7" + "9';"));
...
ok('CHANGELOG 顶部已追加 v23.80 条目（新成就身经百战）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.81（旧 v23.80 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.8" + "0';"));
...
ok('CHANGELOG 顶部已追加 v23.81 条目（胜利/尾声所在地）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.82（旧 v23.81 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.8" + "1';"));
...
ok('CHANGELOG 顶部已追加 v23.82 条目（新成就蘑菇商路）', changelog.startsWith('## v23.83 '));
...
ok('data.js GAME_VERSION 字面量已为 v23.83（旧 v23.82 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.83';") && !dataSrc.includes("const GAME_VERSION = 'v23.8" + "2';"));
