...
ok('data.js GAME_VERSION 字面量为 v22.88', dataSrc.includes("const GAME_VERSION = 'v23.72'"));
...
ok('GAME_VERSION 导出恒等于 v22.88', GAME_VERSION === 'v23.72', GAME_VERSION);
...
ok('CHANGELOG 含 v22.88 条目（顶 pin）', changelog.startsWith('## v23.72 '));
...
ok('smoke_v2287 的 GAME_VERSION 字面量 pin 已更新为 v22.88', s2287.includes("const GAME_VERSION = 'v23.72';"));
ok('smoke_v2287 的 CHANGELOG 顶 pin 已更新为 ## v22.88', s2287.includes("startsWith('## v23.72 '"));
...
ok('smoke_v2286 的 GAME_VERSION 字面量 pin 已更新为 v22.88', s2286.includes("const GAME_VERSION = 'v23.72';"));
...
ok('smoke_v2285 的 GAME_VERSION 字面量 pin 已更新为 v22.88', s2285.includes("const GAME_VERSION = 'v23.72';"));
