...
ok('data.js GAME_VERSION 字面量为 v22.88', dataSrc.includes("const GAME_VERSION = 'v24.01'"));
...
ok('GAME_VERSION 导出恒等于 v22.88', GAME_VERSION === 'v24.01', GAME_VERSION);
...
ok('README 件套口径为二百二十五件套（二百二十四件套清除）且旧 183 口径零残留',
  readme.includes('冒烟二百二十五件套（二百二十四件套清除）') && !readme.includes('一百八十三件套（一百八十二件套清' + '除）'));
...
ok('CHANGELOG 含 v22.88 条目（顶 pin）', changelog.startsWith('## v24.01 '));
...
ok('smoke_v2287 的 GAME_VERSION 字面量 pin 已更新为 v22.88', s2287.includes("const GAME_VERSION = 'v24.01';"));
ok('smoke_v2287 的 CHANGELOG 顶 pin 已更新为 ## v22.88', s2287.includes("startsWith('## v24.01 '"));
ok('smoke_v2287 的件套 pin 已更新为二百二十五件套（二百二十四件套清除）', s2287.includes('二百二十五件套（二百二十四件套清除）'));
...
ok('smoke_v2287 的 testChain pin 已更新为 184', s2287.includes('testChain === 225'));
ok('smoke_v2286 的 GAME_VERSION 字面量 pin 已更新为 v22.88', s2286.includes("const GAME_VERSION = 'v24.01';"));
ok('smoke_v2286 的 testChain pin 已更新为 184', s2286.includes('testChain === 225'));
ok('smoke_v2286 的哨兵 pin 已更新为二百二十五件套（二百二十四件套清除）', s2286.includes('二百二十五件套（二百二十四件套清除）'));
ok('smoke_v2285 的 GAME_VERSION 字面量 pin 已更新为 v22.88', s2285.includes("const GAME_VERSION = 'v24.01';"));
