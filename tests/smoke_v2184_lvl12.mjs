...
ok('GAME_VERSION 格式合法且已越过 v21.83', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 94)), GAME_VERSION);
ok('data.js 含 v21.84 注释（新成就「灯燃长夜」说明）', dSrc.includes('v21.84 新成就「灯燃长夜」'));
ok('data.js GAME_VERSION 字面量已更新为 v21.84', dSrc.includes("const GAME_VERSION = 'v22.94';"));
