...
ok('GAME_VERSION 格式合法且已越过 v21.91', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 97)), GAME_VERSION);
ok('data.js GAME_VERSION 字面量已更新为 v21.92', GAME_VERSION === 'v22.97', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', dataSrc.includes("const GAME_VERSION = 'v22.97';"));
...
ok('README 件套口径为一百九十三件套（一百九十二件套清除）',
  readme.includes('冒烟一百九十三件套（一百九十二件套清除）') && !readme.includes('冒烟八十七件套（八十六件套清除）'));
