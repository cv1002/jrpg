...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', GAME_VERSION === 'v21.93', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', dataSrc.includes("const GAME_VERSION = 'v21.93';"));
...
ok('README tests 树收录 smoke_v2193_hunt100 且位于串尾（v2192 + 新件）', readme.includes('smoke_v2192_travelwarn + smoke_v2193_hunt100（npm test 串跑）'));
