...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', GAME_VERSION === 'v21.99', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', dataSrc.includes("const GAME_VERSION = 'v21.99';"));
...
ok('README tests 树收录 smoke_v2193_hunt100/smoke_v2194_statuscodex/smoke_v2195_ptime2 且位于串尾（v2192 + 新件；v2195 随新现实由当版冒烟守护）', readme.includes('smoke_v2193_hunt100 + smoke_v2194_statuscodex + smoke_v2195_ptime2 + smoke_v2196_deadrecap + smoke_v2197_lucky2 + smoke_v2198_winsave + smoke_v2199_rich2（npm test 串跑）'));
ok('README 件套口径为九十五件套（九十四件套清除）',
  readme.includes('冒烟九十五件套（九十四件套清除）') && !readme.includes('冒烟八十七件套（八十六件套清除）'));
