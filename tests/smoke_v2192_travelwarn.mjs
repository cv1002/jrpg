...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', GAME_VERSION === 'v22.33', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', dataSrc.includes("const GAME_VERSION = 'v22.33';"));
...
ok('README 件套口径为一百二十九件套（一百二十八件套清除）',
  readme.includes('冒烟一百二十九件套（一百二十八件套清除）') && !readme.includes('冒烟八十七件套（八十六件套清除）'));
