...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', GAME_VERSION === 'v21.94', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', dataSrc.includes("const GAME_VERSION = 'v21.94';"));
...
ok('README tests 树收录 smoke_v2193_hunt100/smoke_v2194_statuscodex 且位于串尾（v2192 + 新件；v2194 随新现实由当版冒烟守护）', readme.includes('smoke_v2192_travelwarn + smoke_v2193_hunt100 + smoke_v2194_statuscodex（npm test 串跑）'));
ok('README 件套口径为九十件套（八十九件套清除）',
  readme.includes('冒烟九十件套（八十九件套清除）') && !readme.includes('冒烟八十七件套（八十六件套清除）'));
