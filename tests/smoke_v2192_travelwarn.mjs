...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', GAME_VERSION === 'v21.92', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.92', dataSrc.includes("const GAME_VERSION = 'v21.92';"));
...
ok('README tests 树收录 smoke_v2192_travelwarn 且位于串尾', readme.includes('smoke_v2192_travelwarn（npm test 串跑）'));
