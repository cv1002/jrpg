...
ok('GAME_VERSION 字面量已更新为 v22.12（旧 v22.11 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.07';") && !dSrc.includes("const GAME_VERSION = 'v22.11';"));
...
ok('README 含 smoke_v2212_volume 入库（冒烟一百一十二件套口径）', readme.includes('smoke_v2212_volume') && readme.includes('二百零三件套（二百零二件套清除）'));
