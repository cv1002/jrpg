...
ok('GAME_VERSION 字面量已为 v22.92（旧 v22.91 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.69';") && !dSrc.includes("const GAME_VERSION = 'v22." + "91';"));
...
ok('CHANGELOG 顶部已追加 v22.92 条目', changelog.startsWith('## v23.69 '));
...
ok('smoke_v2291 的 GAME_VERSION 字面量 pin 已更新为 v22.92（旧 v22.91 零残留）',
  s2291.includes("const GAME_VERSION = 'v23.69';") && !s2291.includes("const GAME_VERSION = 'v22." + "91';"));
...
ok('smoke_v2291 的 CHANGELOG 顶 pin 已更新为 ## v22.92', s2291.includes("startsWith('## v23.69 '"));
