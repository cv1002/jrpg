...
ok('data.js GAME_VERSION 字面量已更新为 v21.82（v21.82 起精确版本由当版冒烟守护）', dataSrc.includes("const GAME_VERSION = 'v22.3';"));
...
ok('README 件套口径已更新为九十九件套（九十八件套清除）',
  readme.includes('九十九件套（九十八件套清除）') && !readme.includes('七十五件套（七十四件套清除）'));
...
ok('smoke_v2178 的 README 件套 pin 已随新现实更新为九十九件套（九十八件套清除）',
  s2178.includes("ok('README 件套口径为九十九件套（九十八件套清除）'"));
ok('smoke_v2177 的 README 件套 pin 已随新现实更新为九十九件套（九十八件套清除）',
  s2177.includes("ok('README 件套口径为九十九件套（九十八件套清除）'"));
ok('smoke_v2176 的 README 件套 pin 已随新现实更新为九十九件套（九十八件套清除）',
  s2176.includes("ok('README 件套口径为九十九件套（九十八件套清除）'"));
