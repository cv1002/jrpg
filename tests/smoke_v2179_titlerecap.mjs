...
ok('GAME_VERSION 格式合法且已越过 v21.78', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 86)));
...
ok('data.js GAME_VERSION 字面量已更新为 v21.82（v21.82 起精确版本由当版冒烟守护）', dataSrc.includes("const GAME_VERSION = 'v22.86';"));
...
ok('README 件套口径已更新为一百八十二件套（一百八十一件套清除）',
  readme.includes('一百八十二件套（一百八十一件套清除）') && !readme.includes('七十五件套（七十四件套清除）'));
