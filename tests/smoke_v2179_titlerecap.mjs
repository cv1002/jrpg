...
ok('data.js GAME_VERSION 字面量已更新为 v21.82（v21.82 起精确版本由当版冒烟守护）', dataSrc.includes("const GAME_VERSION = 'v23.09';"));
...
ok('README 件套口径已更新为二百零五件套（二百零四件套清除）',
  readme.includes('二百零五件套（二百零四件套清除）') && !readme.includes('七十五件套（七十四件套清除）'));
