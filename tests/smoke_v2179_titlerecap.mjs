...
ok('data.js GAME_VERSION 字面量已更新为 v21.82（v21.82 起精确版本由当版冒烟守护）', dataSrc.includes("const GAME_VERSION = 'v22.32';"));
...
ok('README 件套口径已更新为一百二十八件套（一百二十七件套清除）',
  readme.includes('一百二十八件套（一百二十七件套清除）') && !readme.includes('七十五件套（七十四件套清除）'));
