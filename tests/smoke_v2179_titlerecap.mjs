...
ok('data.js GAME_VERSION 字面量已更新为 v21.82（v21.82 起精确版本由当版冒烟守护）', dataSrc.includes("const GAME_VERSION = 'v22.68';"));
...
ok('README 件套口径已更新为一百六十四件套（一百六十三件套清除）',
  readme.includes('一百六十四件套（一百六十三件套清除）') && !readme.includes('七十五件套（七十四件套清除）'));
