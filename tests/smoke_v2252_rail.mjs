...
ok('GAME_VERSION 字面量已为 v22.52（旧 v22.51 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.90';") && !dSrc.includes("const GAME_VERSION = 'v22." + "51';"));
...
ok('CHANGELOG 顶部已追加 v22.52 条目', changelog.startsWith('## v23.90'));
...
ok('smoke_v2251 的 GAME_VERSION 字面量 pin 已更新为 v22.52（旧 v22.51 零残留）',
  s2251.includes("const GAME_VERSION = 'v23.90';") && !s2251.includes("const GAME_VERSION = 'v22." + "51';"));
...
ok('smoke_v2251 的 CHANGELOG pin 已更新为 ## v22.52', s2251.includes("startsWith('## v23.90')"));
