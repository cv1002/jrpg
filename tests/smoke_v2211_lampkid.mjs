...
ok('GAME_VERSION 字面量已更新为 v22.11（旧 v22.10 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.15';") && !dSrc.includes("const GAME_VERSION = 'v22.10';"));
...
ok('NPC_SPOTS 总数 20（既有 19 键 + 说书人 1 键，v22.13 随新现实更新）', Object.keys(NPC_SPOTS).length === 20, Object.keys(NPC_SPOTS).length);
