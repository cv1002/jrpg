...
ok('GAME_VERSION 字面量已更新为 v22.11（旧 v22.10 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.11';") && !dSrc.includes("const GAME_VERSION = 'v22.10';"));
...
ok('NPC_SPOTS 总数 19（既有 18 键 + 掌灯童 1 键）', Object.keys(NPC_SPOTS).length === 19, Object.keys(NPC_SPOTS).length);
ok('既有 18 个 NPC/石碑键未被误动', ['13,6', '10,13', '19,8', '12,8', '2,4', '13,9', '3,1', '2,3', '17,12', '17,11', '5,1', '10,1', '15,1', '20,1', '8,5', '14,8', '5,10', '15,12']
