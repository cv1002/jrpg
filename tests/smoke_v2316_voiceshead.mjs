...
ok('data.js GAME_VERSION 字面量已为 v23.16（旧 v23.15 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.53';") && !dataSrc.includes("const GAME_VERSION = 'v23.15';"));
...
ok('CHANGELOG 顶部已追加 v23.16 条目', changelog.startsWith('## v23.53 '));
...
ok('smoke_v2315 的 GAME_VERSION 字面量 pin 已更新为 v23.16', s2315.includes("const GAME_VERSION = 'v23.53';"));
ok('smoke_v2315 的 CHANGELOG 顶 pin 已更新为 ## v23.27', s2315.includes("startsWith('## v23.53 "));
