...
ok('GAME_VERSION 字面量已为 v22.17（本版独占精确锚点）', GAME_VERSION === 'v23.09', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.17（旧 v22.16 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.09';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "16';"));
...
ok('README 件套口径为二百零五件套（二百零四件套清除）',
  readme.includes('冒烟二百零五件套（二百零四件套清除）') && !readme.includes('冒烟一百一十二件套（一百一十一件套清' + '除）'));
...
ok('smoke_v2216 的 GAME_VERSION 字面量 pin 已更新为 v22.17', s2216.includes("const GAME_VERSION = 'v23.09';"));
ok('smoke_v2216 的 GAME_VERSION 恒等 pin 已更新为 === v22.17', s2216.includes("GAME_VERSION === 'v23.09'"));
ok('smoke_v2216 的 package.json 件套计数 pin 已更新为 === 113', s2216.includes('testChain === 205'));
ok('smoke_v2215 的 GAME_VERSION 字面量 pin 已更新为 v22.17', s2215.includes("const GAME_VERSION = 'v23.09';"));
ok('smoke_v2215 的 package.json 件套计数 pin 已更新为 === 113', s2215.includes('testChain === 205'));
