...
ok('GAME_VERSION 字面量已为 v22.17（本版独占精确锚点）', GAME_VERSION === 'v23.27', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.17（旧 v22.16 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.27';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "16';"));
...
ok('smoke_v2216 的 GAME_VERSION 字面量 pin 已更新为 v22.17', s2216.includes("const GAME_VERSION = 'v23.27';"));
ok('smoke_v2216 的 GAME_VERSION 恒等 pin 已更新为 === v22.17', s2216.includes("GAME_VERSION === 'v23.27'"));
ok('smoke_v2216 的 package.json 件套计数 pin 已更新为 === 113', s2216.includes('testChain === 212'));
ok('smoke_v2215 的 GAME_VERSION 字面量 pin 已更新为 v22.17', s2215.includes("const GAME_VERSION = 'v23.27';"));
