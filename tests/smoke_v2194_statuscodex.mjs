...
ok('GAME_VERSION 字面量已为 v21.94', GAME_VERSION === 'v22.77', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.94', dataSrc.includes("const GAME_VERSION = 'v22.77';"));
...
ok('README 已同步（tests 树收录 smoke_v2194_statuscodex + 九十件套口径）',
  readme.includes('smoke_v2194_statuscodex') && readme.includes('一百七十三件套（一百七十二件套清除）'));
