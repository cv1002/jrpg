...
ok('GAME_VERSION 格式合法且已越过 v21.93', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 96)), GAME_VERSION);
ok('GAME_VERSION 字面量已为 v21.94', GAME_VERSION === 'v22.96', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.94', dataSrc.includes("const GAME_VERSION = 'v22.96';"));
...
ok('README 已同步（tests 树收录 smoke_v2194_statuscodex + 九十件套口径）',
  readme.includes('smoke_v2194_statuscodex') && readme.includes('一百九十二件套（一百九十一件套清除）'));
