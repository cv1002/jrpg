...
ok('GAME_VERSION 字面量已为 v21.94', GAME_VERSION === 'v21.97', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.94', dataSrc.includes("const GAME_VERSION = 'v21.97';"));
...
ok('README 已同步（tests 树收录 smoke_v2194_statuscodex + 九十件套口径）',
  readme.includes('smoke_v2194_statuscodex') && readme.includes('九十三件套（九十二件套清除）'));
