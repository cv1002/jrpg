...
// —— 版本锚点 ——
ok('GAME_VERSION 恒等 v22.40', GAME_VERSION === 'v23.34', GAME_VERSION);
const dSrc = fs.readFileSync(path.join(ROOT, 'js/data.js'), 'utf8');
ok('data.js GAME_VERSION 字面量 v22.40 精确', dSrc.includes("const GAME_VERSION = 'v23.34';"));
...
ok('smoke_v2239 的 GAME_VERSION 字面量 pin 已更新为 v22.40', s2239.includes("const GAME_VERSION = 'v23.34';"));
ok('smoke_v2239 的 GAME_VERSION 恒等 pin 已更新为 === v22.40', s2239.includes("GAME_VERSION === 'v23.34'"));
...
ok('smoke_v2238 的 GAME_VERSION 字面量 pin 已更新为 v22.40', s2238.includes("const GAME_VERSION = 'v23.34';"));
ok('smoke_v2237 的 GAME_VERSION 字面量 pin 已更新为 v22.40', s2237.includes("const GAME_VERSION = 'v23.34';"));
ok('smoke_v2235 的 GAME_VERSION 字面量 pin 已更新为 v22.40', s2235.includes("const GAME_VERSION = 'v23.34';"));
ok('smoke_v2234 的 GAME_VERSION 恒等 pin 已更新为 === v22.40', s2234.includes("GAME_VERSION === 'v23.34'"));
ok('smoke_v2230 的 GAME_VERSION 恒等 pin 已更新为 === v22.40', s2230.includes("GAME_VERSION === 'v23.34'"));
