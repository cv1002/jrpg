...
ok('data.js GAME_VERSION 字面量已为 v22.99（旧 v22.98 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.48';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "98';"));
...
ok('CHANGELOG 顶部已追加 v22.99 条目', changelog.startsWith('## v23.48 '));
...
ok('smoke_v2298 的 GAME_VERSION 字面量 pin 已更新为 v22.99', s2298.includes("const GAME_VERSION = 'v23.48';"));
ok('smoke_v2298 的 CHANGELOG 顶 pin 已更新为 ## v22.99',
  s2298.includes("startsWith('## v23.48 '"));
