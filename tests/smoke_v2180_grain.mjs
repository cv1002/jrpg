...
ok('GAME_VERSION 格式合法且已越过 v21.79', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 84)), GAME_VERSION);
...
ok('smoke_v2179 的 README 件套 pin 已随新现实更新为一百八十件套（一百七十九件套清除）',
  s2179.includes("ok('README 件套口径已更新为一百八十件套（一百七十九件套清除）'"));
...
ok('smoke_v2178 的 README 件套 pin 已随新现实更新为一百八十件套（一百七十九件套清除）',
  s2178.includes("ok('README 件套口径为一百八十件套（一百七十九件套清除）'"));
...
ok('smoke_v2177 的 README 件套 pin 已随新现实更新为一百八十件套（一百七十九件套清除）',
  s2177.includes("ok('README 件套口径为一百八十件套（一百七十九件套清除）'"));
...
ok('smoke_v2176 的 README 件套 pin 已随新现实更新为一百八十件套（一百七十九件套清除）',
  s2176.includes("ok('README 件套口径为一百八十件套（一百七十九件套清除）'"));
