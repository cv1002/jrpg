...
ok('README 件套口径为一百零六件套（一百零五件套清除）', readme.includes('一百零六件套（一百零五件套清除）'));
...
ok('smoke_v2179 的 README 件套 pin 已随新现实更新为一百零六件套（一百零五件套清除）',
  s2179.includes("ok('README 件套口径已更新为一百零六件套（一百零五件套清除）'"));
...
ok('smoke_v2178 的 README 件套 pin 已随新现实更新为一百零六件套（一百零五件套清除）',
  s2178.includes("ok('README 件套口径为一百零六件套（一百零五件套清除）'"));
...
ok('smoke_v2177 的 README 件套 pin 已随新现实更新为一百零六件套（一百零五件套清除）',
  s2177.includes("ok('README 件套口径为一百零六件套（一百零五件套清除）'"));
...
ok('smoke_v2176 的 README 件套 pin 已随新现实更新为一百零六件套（一百零五件套清除）',
  s2176.includes("ok('README 件套口径为一百零六件套（一百零五件套清除）'"));
