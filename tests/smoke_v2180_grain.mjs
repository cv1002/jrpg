...
ok('README 件套口径为一百六十一件套（一百六十件套清除）', readme.includes('一百六十一件套（一百六十件套清除）'));
...
ok('smoke_v2179 的 README 件套 pin 已随新现实更新为一百六十一件套（一百六十件套清除）',
  s2179.includes("ok('README 件套口径已更新为一百六十一件套（一百六十件套清除）'"));
...
ok('smoke_v2178 的 README 件套 pin 已随新现实更新为一百六十一件套（一百六十件套清除）',
  s2178.includes("ok('README 件套口径为一百六十一件套（一百六十件套清除）'"));
...
ok('smoke_v2177 的 README 件套 pin 已随新现实更新为一百六十一件套（一百六十件套清除）',
  s2177.includes("ok('README 件套口径为一百六十一件套（一百六十件套清除）'"));
...
ok('smoke_v2176 的 README 件套 pin 已随新现实更新为一百六十一件套（一百六十件套清除）',
  s2176.includes("ok('README 件套口径为一百六十一件套（一百六十件套清除）'"));
...
ok('smoke_v2176 的 README 成就 pin 已随新现实更新（28 项 pin 零残留，31 项双处落位）',
  s2176.includes("readme.includes('成就一览（全部 49 项进度'") && !s2176.includes('全部 28 项进度'));
ok('smoke_v2173 的 README 成就 pin 已随新现实更新（28 项 pin 零残留，31 项双处落位）',
  fs.readFileSync(path.join(ROOT, 'tests/smoke_v2173_aegis.mjs'), 'utf8')
    .includes("readme.includes('成就一览（全部 49 项进度'"));
