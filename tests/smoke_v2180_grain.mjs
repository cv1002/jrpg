...
ok('README 件套口径为七十六件套（七十五件套清除）', readme.includes('七十六件套（七十五件套清除）'));
...
ok('smoke_v2179 的 README 件套 pin 已随新现实更新为七十六件套（七十五件套清除）',
  s2179.includes("ok('README 件套口径已更新为七十六件套（七十五件套清除）'"));
