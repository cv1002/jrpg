...
ok('GAME_VERSION 格式合法且已越过 v21.85', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 87)), GAME_VERSION);
ok('data.js 含 v21.86 注释（新成就「灵药初成」说明）', dSrc.includes('v21.86 新成就「灵药初成」'));
ok('data.js GAME_VERSION 字面量已更新为 v21.86', dSrc.includes("const GAME_VERSION = 'v22.87';"));
