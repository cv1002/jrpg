...
ok('data.js GAME_VERSION 字面量为 v22.93', dataSrc.includes("const GAME_VERSION = 'v23.02';"));
...
ok('README tests 树串尾已延伸至 smoke_v2293_deadsave（v2292 后接 v2293）',
  readme.includes('smoke_v2291_lampguide + smoke_v2292_cavewatch + smoke_v2293_deadsave + smoke_v2294_crystalwatch + smoke_v2295_deadprog + smoke_v2296_endingprog + smoke_v2297_chestmid + smoke_v2298_encnum + smoke_v2299_crosslink + smoke_v2300_sidemore + smoke_v2301_eco + smoke_v2302_cmdprev（npm test 串跑）'));
...
ok('package.json test 串含 smoke_v2293_deadsave.mjs 且位于串尾',
  pkg.includes('node tests/smoke_v2292_cavewatch.mjs && node tests/smoke_v2293_deadsave.mjs && node tests/smoke_v2294_crystalwatch.mjs && node tests/smoke_v2295_deadprog.mjs && node tests/smoke_v2296_endingprog.mjs && node tests/smoke_v2297_chestmid.mjs && node tests/smoke_v2298_encnum.mjs && node tests/smoke_v2299_crosslink.mjs && node tests/smoke_v2300_sidemore.mjs && node tests/smoke_v2301_eco.mjs && node tests/smoke_v2302_cmdprev.mjs"'));
const testChain = (pkg.match(/node tests\/smoke/g) || []).length;
ok('package.json test 串共 189 件套', testChain === 198, String(testChain));
ok('CHANGELOG 含 v22.93 条目（顶 pin）', changelog.startsWith('## v23.02 '));
...
ok('smoke_v2292 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2292.includes("const GAME_VERSION = 'v23.02';"));
ok('smoke_v2292 的 CHANGELOG 顶 pin 已更新为 ## v22.93', s2292.includes("startsWith('## v23.02 '"));
ok('smoke_v2292 的件套 pin 已更新为一百九十八件套（一百九十七件套清除）', s2292.includes('一百九十八件套（一百九十七件套清除）'));
ok('smoke_v2292 的 README 串尾 pin 已延伸至 smoke_v2293_deadsave',
  s2292.includes('smoke_v2291_lampguide + smoke_v2292_cavewatch + smoke_v2293_deadsave + smoke_v2294_crystalwatch + smoke_v2295_deadprog + smoke_v2296_endingprog + smoke_v2297_chestmid + smoke_v2298_encnum + smoke_v2299_crosslink + smoke_v2300_sidemore + smoke_v2301_eco + smoke_v2302_cmdprev（npm test 串跑）'));
ok('smoke_v2292 的 package 串尾 pin 已延伸至 smoke_v2293_deadsave',
  s2292.includes('node tests/smoke_v2292_cavewatch.mjs && node tests/smoke_v2293_deadsave.mjs && node tests/smoke_v2294_crystalwatch.mjs && node tests/smoke_v2295_deadprog.mjs && node tests/smoke_v2296_endingprog.mjs && node tests/smoke_v2297_chestmid.mjs && node tests/smoke_v2298_encnum.mjs && node tests/smoke_v2299_crosslink.mjs && node tests/smoke_v2300_sidemore.mjs && node tests/smoke_v2301_eco.mjs && node tests/smoke_v2302_cmdprev.mjs"'));
ok('smoke_v2292 的 testChain pin 已更新为 189', s2292.includes('testChain === 198'));
ok('smoke_v2291 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2291.includes("const GAME_VERSION = 'v23.02';"));
ok('smoke_v2291 的 testChain pin 已更新为 189', s2291.includes('testChain === 198'));
ok('smoke_v2290 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2290.includes("const GAME_VERSION = 'v23.02';"));
ok('smoke_v2290 的 testChain pin 已更新为 189', s2290.includes('testChain === 198'));
