...
ok('data.js GAME_VERSION 字面量为 v22.93', dataSrc.includes("const GAME_VERSION = 'v23.93';"));
...
ok('README 件套口径为二百一十七件套（二百一十六件套清除）且旧 188 口径零残留',
  readme.includes('冒烟二百一十七件套（二百一十六件套清除）') && !readme.includes('冒烟一百八十八件套（一百八十七件套清' + '除）'));
...
ok('package.json test 串共 189 件套', testChain === 217, String(testChain));
ok('CHANGELOG 含 v22.93 条目（顶 pin）', changelog.startsWith('## v23.93 '));
...
ok('smoke_v2292 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2292.includes("const GAME_VERSION = 'v23.93';"));
ok('smoke_v2292 的 CHANGELOG 顶 pin 已更新为 ## v22.93', s2292.includes("startsWith('## v23.93 '"));
ok('smoke_v2292 的件套 pin 已更新为二百一十七件套（二百一十六件套清除）', s2292.includes('二百一十七件套（二百一十六件套清除）'));
...
ok('smoke_v2292 的 testChain pin 已更新为 189', s2292.includes('testChain === 217'));
ok('smoke_v2291 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2291.includes("const GAME_VERSION = 'v23.93';"));
ok('smoke_v2291 的 testChain pin 已更新为 189', s2291.includes('testChain === 217'));
ok('smoke_v2290 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2290.includes("const GAME_VERSION = 'v23.93';"));
ok('smoke_v2290 的 testChain pin 已更新为 189', s2290.includes('testChain === 217'));
