...
ok('data.js GAME_VERSION 字面量为 v22.93', dataSrc.includes("const GAME_VERSION = 'v23.33';"));
...
ok('CHANGELOG 含 v22.93 条目（顶 pin）', changelog.startsWith('## v23.33 '));
...
ok('smoke_v2292 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2292.includes("const GAME_VERSION = 'v23.33';"));
ok('smoke_v2292 的 CHANGELOG 顶 pin 已更新为 ## v22.93', s2292.includes("startsWith('## v23.33 '"));
...
ok('smoke_v2291 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2291.includes("const GAME_VERSION = 'v23.33';"));
ok('smoke_v2291 的 testChain pin 已更新为 189', s2291.includes('testChain === 212'));
ok('smoke_v2290 的 GAME_VERSION 字面量 pin 已更新为 v22.93', s2290.includes("const GAME_VERSION = 'v23.33';"));
