...
ok('GAME_VERSION 字面量已为 v22.30（旧 v22.29 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.49';") && !dSrc.includes("const GAME_VERSION = 'v22." + "29';"));
...
ok('README 件套口径为一百四十五件套（一百四十四件套清除）',
  readme.includes('冒烟一百四十五件套（一百四十四件套清除）') && !readme.includes('冒烟一百二十五件套（一百二十四件套清' + '除）'));
...
ok('package.json test 串共 126 件套', testChain === 145, String(testChain));
...
ok('smoke_v2229 的 GAME_VERSION 字面量 pin 已更新为 v22.30', s2229.includes("const GAME_VERSION = 'v22.49';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.30', s2229.includes("GAME_VERSION === 'v22.49'"));
ok('smoke_v2229 的 README 件套 pin 已更新为一百四十五件套（一百四十四件套清除）',
...
ok('smoke_v2229 的 package.json 件套计数 pin 已更新为 === 126', s2229.includes('testChain === 145'));
ok('smoke_v2229 的 package.json 串尾 pin 已更新为 + smoke_v2232_travelsup',
  s2229.includes('node tests\\/smoke_v2230_pausewarn\\.mjs && node tests\\/smoke_v2231_smith\\.mjs && node tests\\/smoke_v2232_travelsup\\.mjs && node tests\\/smoke_v2233_nameflavor\\.mjs && node tests\\/smoke_v2234_innkeeper\\.mjs && node tests\\/smoke_v2235_minimapquest\\.mjs && node tests\\/smoke_v2236_villagelamp\\.mjs && node tests\\/smoke_v2237_minimaplegend\\.mjs && node tests\\/smoke_v2238_starwell\\.mjs && node tests\\/smoke_v2239_minercart\\.mjs && node tests\\/smoke_v2240_tallgrass\\.mjs && node tests\\/smoke_v2241_gatearch.mjs && node tests\\/smoke_v2242_mushfield.mjs && node tests\\/smoke_v2243_encguide.mjs && node tests\\/smoke_v2244_fulldanger.mjs && node tests\\/smoke_v2245_watcher.mjs && node tests\\/smoke_v2246_fountgauge.mjs && node tests\\/smoke_v2247_villagewell.mjs && node tests\\/smoke_v2248_mapguide.mjs && node tests\\/smoke_v2249_shopkeep.mjs"'));
ok('smoke_v2228 的 GAME_VERSION 字面量 pin 已更新为 v22.30', s2228.includes("const GAME_VERSION = 'v22.49';"));
...
ok('smoke_v2226 的 README 件套 pin 已更新为一百四十五件套（一百四十四件套清除）',
