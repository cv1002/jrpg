...
ok('data.js GAME_VERSION 字面量为 v22.86', dataSrc.includes("const GAME_VERSION = 'v23.01'"));
...
ok('GAME_VERSION 导出恒等于 v22.86', GAME_VERSION === 'v23.01', GAME_VERSION);
...
ok('README 件套口径为一百九十七件套（一百九十六件套清除）且旧 181 口径零残留',
  readme.includes('冒烟一百九十七件套（一百九十六件套清除）') && !readme.includes('冒烟一百八十一件套（一百八十件套清' + '除）'));
...
ok('package.json test 串共 182 件套', testChain === 197, String(testChain));
ok('CHANGELOG 含 v22.86 条目（顶 pin）', changelog.startsWith('## v23.01 '));
...
ok('smoke_v2285 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2285.includes("const GAME_VERSION = 'v23.01';"));
ok('smoke_v2285 的 CHANGELOG 顶 pin 已更新为 ## v22.86', s2285.includes("startsWith('## v23.01 '"));
ok('smoke_v2285 的件套 pin 已更新为一百九十七件套（一百九十六件套清除）', s2285.includes('一百九十七件套（一百九十六件套清除）'));
...
ok('smoke_v2284 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2284.includes("const GAME_VERSION = 'v23.01';"));
ok('smoke_v2284 的 CHANGELOG 顶 pin 已更新为 ## v22.86', s2284.includes("startsWith('## v23.01 '"));
ok('smoke_v2284 的件套 pin 已更新为一百九十七件套（一百九十六件套清除）', s2284.includes('一百九十七件套（一百九十六件套清除）'));
...
ok('smoke_v2283 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2283.includes("const GAME_VERSION = 'v23.01';"));
ok('smoke_v2283 的 CHANGELOG 顶 pin 已更新为 ## v22.86', s2283.includes("startsWith('## v23.01 '"));
ok('smoke_v2283 的 testChain pin 已更新为 182', s2283.includes('testChain === 197'));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2282.includes("const GAME_VERSION = 'v23.01';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.86', s2282.includes("startsWith('## v23.01 '"));
ok('smoke_v2282 的 testChain pin 已更新为 182', s2282.includes('testChain === 197'));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2281.includes("const GAME_VERSION = 'v23.01';"));
