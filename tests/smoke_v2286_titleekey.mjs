...
ok('data.js GAME_VERSION 字面量为 v22.86', dataSrc.includes("const GAME_VERSION = 'v23.17'"));
...
ok('GAME_VERSION 导出恒等于 v22.86', GAME_VERSION === 'v23.17', GAME_VERSION);
...
ok('smoke_v2285 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2285.includes("const GAME_VERSION = 'v23.17';"));
...
ok('smoke_v2284 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2284.includes("const GAME_VERSION = 'v23.17';"));
...
ok('smoke_v2283 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2283.includes("const GAME_VERSION = 'v23.17';"));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2282.includes("const GAME_VERSION = 'v23.17';"));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2281.includes("const GAME_VERSION = 'v23.17';"));
