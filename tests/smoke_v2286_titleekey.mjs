...
ok('data.js GAME_VERSION 字面量为 v22.86', dataSrc.includes("const GAME_VERSION = 'v22.89'"));
...
ok('GAME_VERSION 导出恒等于 v22.86', GAME_VERSION === 'v22.89', GAME_VERSION);
...
ok('README tests 树串尾已延伸至 smoke_v2286_titleekey（v2285 后接 v2286）',
  readme.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog（npm test 串跑）'));
ok('README 件套口径为一百八十五件套（一百八十四件套清除）且旧 181 口径零残留',
  readme.includes('冒烟一百八十五件套（一百八十四件套清除）') && !readme.includes('冒烟一百八十一件套（一百八十件套清' + '除）'));
...
ok('package.json test 串含 smoke_v2286_titleekey.mjs 且位于串尾',
  pkg.includes('node tests/smoke_v2285_winekey.mjs && node tests/smoke_v2286_titleekey.mjs && node tests/smoke_v2287_trueroute.mjs && node tests/smoke_v2288_scrollhint.mjs && node tests/smoke_v2289_winprog.mjs"'));
const testChain = (pkg.match(/node tests\/smoke/g) || []).length;
ok('package.json test 串共 182 件套', testChain === 185, String(testChain));
ok('CHANGELOG 含 v22.86 条目（顶 pin）', changelog.startsWith('## v22.89 '));
...
ok('smoke_v2285 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2285.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2285 的 CHANGELOG 顶 pin 已更新为 ## v22.86', s2285.includes("startsWith('## v22.89 '"));
ok('smoke_v2285 的件套 pin 已更新为一百八十五件套（一百八十四件套清除）', s2285.includes('一百八十五件套（一百八十四件套清除）'));
ok('smoke_v2285 的 README 串尾 pin 已延伸至 smoke_v2286_titleekey', s2285.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog（npm test 串跑）'));
ok('smoke_v2285 的 package 串尾 pin 已延伸至 smoke_v2286_titleekey', s2285.includes('node tests/smoke_v2285_winekey.mjs && node tests/smoke_v2286_titleekey.mjs && node tests/smoke_v2287_trueroute.mjs && node tests/smoke_v2288_scrollhint.mjs && node tests/smoke_v2289_winprog.mjs"'));
ok('smoke_v2284 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2284.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2284 的 CHANGELOG 顶 pin 已更新为 ## v22.86', s2284.includes("startsWith('## v22.89 '"));
ok('smoke_v2284 的件套 pin 已更新为一百八十五件套（一百八十四件套清除）', s2284.includes('一百八十五件套（一百八十四件套清除）'));
ok('smoke_v2284 的 README 串尾 pin 已延伸至 smoke_v2286_titleekey', s2284.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog（npm test 串跑）'));
ok('smoke_v2284 的 package 串尾 pin 已延伸至 smoke_v2286_titleekey', s2284.includes('node tests/smoke_v2285_winekey.mjs && node tests/smoke_v2286_titleekey.mjs && node tests/smoke_v2287_trueroute.mjs && node tests/smoke_v2288_scrollhint.mjs && node tests/smoke_v2289_winprog.mjs"'));
ok('smoke_v2283 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2283.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2283 的 CHANGELOG 顶 pin 已更新为 ## v22.86', s2283.includes("startsWith('## v22.89 '"));
ok('smoke_v2283 的 testChain pin 已更新为 182', s2283.includes('testChain === 185'));
ok('smoke_v2283 的 README 串尾 pin 已延伸至 smoke_v2286_titleekey', s2283.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog（npm test 串跑）'));
ok('smoke_v2283 的 package 串尾 pin 已延伸至 smoke_v2286_titleekey', s2283.includes('node tests/smoke_v2284_skillekey.mjs && node tests/smoke_v2285_winekey.mjs && node tests/smoke_v2286_titleekey.mjs && node tests/smoke_v2287_trueroute.mjs && node tests/smoke_v2288_scrollhint.mjs && node tests/smoke_v2289_winprog.mjs"'));
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2282.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.86', s2282.includes("startsWith('## v22.89 '"));
ok('smoke_v2282 的 testChain pin 已更新为 182', s2282.includes('testChain === 185'));
ok('smoke_v2282 的 README 串尾 pin 已延伸至 smoke_v2286_titleekey', s2282.includes('smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog（npm test 串跑）'));
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.86', s2281.includes("const GAME_VERSION = 'v22.89';"));
...
ok('哨兵链 v2143 已含下一版件套口径（一百八十六件套（一百八十五件套清除））', s2143.includes('一百八十六件套（一百八十五件套清除）'));
