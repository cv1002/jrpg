...
ok('data.js GAME_VERSION 字面量已为 v24.02（旧 v23.99 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v24.02';") && !dSrc.includes("const GAME_VERSION = 'v23.9" + "8';"));
...
ok('package.json test 串共 223 件套', testChain === 226, String(testChain));
ok('package.json 已收录 smoke_v2398_econrow（npm test 串跑第 222 份）',
  JSON.parse(pkg).scripts.test.includes('smoke_v2398_econrow.mjs'));
ok('package.json 串尾为 ... smoke_v2397_baserow.mjs && node tests/smoke_v2398_econrow.mjs && node tests/smoke_v2399_dmgformula.mjs && node tests/smoke_v2400_trialwarn.mjs && node tests/smoke_v2401_winbgm.mjs && node tests/smoke_v2402_firstwin.mjs"',
  pkg.includes('node tests/smoke_v2397_baserow.mjs && node tests/smoke_v2398_econrow.mjs && node tests/smoke_v2399_dmgformula.mjs && node tests/smoke_v2400_trialwarn.mjs && node tests/smoke_v2401_winbgm.mjs && node tests/smoke_v2402_firstwin.mjs"'));
ok('README tests 树串尾已延伸至 smoke_v2399_dmgformula',
  readme.includes('+ smoke_v2397_baserow + smoke_v2398_econrow + smoke_v2399_dmgformula + smoke_v2400_trialwarn + smoke_v2401_winbgm + smoke_v2402_firstwin（npm test 串跑）'));
