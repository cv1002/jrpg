...
ok('GAME_VERSION 字面量已为 v22.28（旧 v22.27 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v22.68';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "27';"));
...
ok('README 件套口径为一百六十四件套（一百六十三件套清除）',
  readme.includes('冒烟一百六十四件套（一百六十三件套清除）') && !readme.includes('一百二十三件套（一百二十二件套清' + '除）'));
...
ok('package.json test 串共 124 件套', testChain === 164, String(testChain));
...
ok('smoke_v2227 的 GAME_VERSION 字面量 pin 已更新为 v22.28', s2227.includes("const GAME_VERSION = 'v22.68';"));
ok('smoke_v2227 的 GAME_VERSION 恒等 pin 已更新为 === v22.28', s2227.includes("GAME_VERSION === 'v22.68'"));
ok('smoke_v2227 的 README 件套 pin 已更新为一百六十四件套（一百六十三件套清除）',
  s2227.includes('一百六十四件套（一百六十三件套清除）'));
...
ok('smoke_v2227 的 package.json 件套计数 pin 已更新为 === 124', s2227.includes('testChain === 164'));
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.28', s2226.includes("const GAME_VERSION = 'v22.68';"));
