...
ok('GAME_VERSION 字面量已为 v22.28（旧 v22.27 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.73';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "27';"));
...
ok('smoke_v2227 的 GAME_VERSION 字面量 pin 已更新为 v22.28', s2227.includes("const GAME_VERSION = 'v23.73';"));
ok('smoke_v2227 的 GAME_VERSION 恒等 pin 已更新为 === v22.28', s2227.includes("GAME_VERSION === 'v23.73'"));
...
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.28', s2226.includes("const GAME_VERSION = 'v23.73';"));
