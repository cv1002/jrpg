...
ok('GAME_VERSION 字面量已为 v22.33（旧 v22.32 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.64';") && !dSrc.includes("const GAME_VERSION = 'v22." + "32';"));
...
ok('smoke_v2232 的 GAME_VERSION 字面量 pin 已更新为 v22.33', s2232.includes("const GAME_VERSION = 'v23.64';"));
ok('smoke_v2232 的 GAME_VERSION 恒等 pin 已更新为 === v22.33', s2232.includes("GAME_VERSION === 'v23.64'"));
...
ok('smoke_v2231 的 GAME_VERSION 字面量 pin 已更新为 v22.33', s2231.includes("const GAME_VERSION = 'v23.64';"));
...
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.33', s2230.includes("const GAME_VERSION = 'v23.64';"));
...
ok('smoke_v2229 的 GAME_VERSION 字面量 pin 已更新为 v22.33', s2229.includes("const GAME_VERSION = 'v23.64';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.33', s2229.includes("GAME_VERSION === 'v23.64'"));
