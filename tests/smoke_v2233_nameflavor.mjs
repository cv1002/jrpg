...
ok('GAME_VERSION 字面量已为 v22.33（旧 v22.32 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.44';") && !dSrc.includes("const GAME_VERSION = 'v22." + "32';"));
...
ok('README 件套口径为一百四十件套（一百三十九件套清除）',
  readme.includes('冒烟一百四十件套（一百三十九件套清除）') && !readme.includes('冒烟一百二十八件套（一百二十七件套清' + '除）'));
...
ok('package.json test 串共 129 件套', testChain === 140, String(testChain));
...
ok('smoke_v2232 的 GAME_VERSION 字面量 pin 已更新为 v22.33', s2232.includes("const GAME_VERSION = 'v22.44';"));
ok('smoke_v2232 的 GAME_VERSION 恒等 pin 已更新为 === v22.33', s2232.includes("GAME_VERSION === 'v22.44'"));
ok('smoke_v2232 的 README 件套 pin 已随新现实更新为一百四十件套（一百三十九件套清除）',
  s2232.includes('一百四十件套（一百三十九件套清除）'));
...
ok('smoke_v2232 的 package.json 件套计数 pin 已更新为 === 129', s2232.includes('testChain === 140'));
ok('smoke_v2231 的 GAME_VERSION 字面量 pin 已更新为 v22.33', s2231.includes("const GAME_VERSION = 'v22.44';"));
ok('smoke_v2231 的 README 件套 pin 已随新现实更新为一百四十件套（一百三十九件套清除）',
  s2231.includes('一百四十件套（一百三十九件套清除）'));
...
ok('smoke_v2231 的 package.json 件套计数 pin 已更新为 === 129', s2231.includes('testChain === 140'));
ok('smoke_v2230 的 GAME_VERSION 字面量 pin 已更新为 v22.33', s2230.includes("const GAME_VERSION = 'v22.44';"));
ok('smoke_v2230 的 README 树尾 pin 已更新为 + smoke_v2233_nameflavor',
  s2230.includes('smoke_v2229_metall + smoke_v2230_pausewarn + smoke_v2231_smith + smoke_v2232_travelsup + smoke_v2233_nameflavor + smoke_v2234_innkeeper + smoke_v2235_minimapquest + smoke_v2236_villagelamp + smoke_v2237_minimaplegend + smoke_v2238_starwell + smoke_v2240_tallgrass + smoke_v2241_gatearch + smoke_v2242_mushfield + smoke_v2243_encguide + smoke_v2244_fulldanger（npm test 串跑）'));
ok('smoke_v2230 的 package.json 件套计数 pin 已更新为 === 129', s2230.includes('testChain === 140'));
ok('smoke_v2229 的 GAME_VERSION 字面量 pin 已更新为 v22.33', s2229.includes("const GAME_VERSION = 'v22.44';"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.33', s2229.includes("GAME_VERSION === 'v22.44'"));
ok('smoke_v2229 的 README 件套 pin 已随新现实更新为一百四十件套（一百三十九件套清除）',
  s2229.includes('一百四十件套（一百三十九件套清除）'));
ok('smoke_v2229 的 README 树尾 pin 已更新为 + smoke_v2233_nameflavor',
  s2229.includes('smoke_v2229_metall + smoke_v2230_pausewarn + smoke_v2231_smith + smoke_v2232_travelsup + smoke_v2233_nameflavor + smoke_v2234_innkeeper + smoke_v2235_minimapquest + smoke_v2236_villagelamp + smoke_v2237_minimaplegend + smoke_v2238_starwell + smoke_v2240_tallgrass + smoke_v2241_gatearch + smoke_v2242_mushfield + smoke_v2243_encguide + smoke_v2244_fulldanger（npm test 串跑）'));
ok('smoke_v2229 的 package.json 件套计数 pin 已更新为 === 129', s2229.includes('testChain === 140'));
