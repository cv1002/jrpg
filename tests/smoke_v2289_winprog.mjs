...
ok('GAME_VERSION 恒等于 v22.89', GAME_VERSION === 'v23.73', GAME_VERSION);
...
// 2. 源级落位
ok('data.js GAME_VERSION 字面量为 v22.89', dataSrc.includes("const GAME_VERSION = 'v23.73';"));
...
ok('CHANGELOG 含 v22.89 条目（顶 pin）', changelog.startsWith('## v23.73 '));
...
ok('smoke_v2288 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2288.includes("const GAME_VERSION = 'v23.73';"));
ok('smoke_v2288 的 CHANGELOG 顶 pin 已更新为 ## v22.89', s2288.includes("startsWith('## v23.73 '"));
...
ok('smoke_v2287 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2287.includes("const GAME_VERSION = 'v23.73';"));
...
ok('smoke_v2286 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2286.includes("const GAME_VERSION = 'v23.73';"));
