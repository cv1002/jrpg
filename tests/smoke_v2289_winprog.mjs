...
ok('GAME_VERSION 恒等于 v22.89', GAME_VERSION === 'v23.90', GAME_VERSION);
...
// 2. 源级落位
ok('data.js GAME_VERSION 字面量为 v22.89', dataSrc.includes("const GAME_VERSION = 'v23.90';"));
...
ok('README 件套口径为二百一十五件套（二百一十四件套清除）且旧 184 口径零残留',
  readme.includes('冒烟二百一十五件套（二百一十四件套清除）') && !readme.includes('一百八十四件套（一百八十三件套清' + '除）'));
...
ok('package.json test 串共 185 件套', testChain === 215, String(testChain));
ok('CHANGELOG 含 v22.89 条目（顶 pin）', changelog.startsWith('## v23.90 '));
...
ok('smoke_v2288 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2288.includes("const GAME_VERSION = 'v23.90';"));
ok('smoke_v2288 的 CHANGELOG 顶 pin 已更新为 ## v22.89', s2288.includes("startsWith('## v23.90 '"));
ok('smoke_v2288 的件套 pin 已更新为二百一十五件套（二百一十四件套清除）', s2288.includes('二百一十五件套（二百一十四件套清除）'));
...
ok('smoke_v2288 的 testChain pin 已更新为 185', s2288.includes('testChain === 215'));
ok('smoke_v2287 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2287.includes("const GAME_VERSION = 'v23.90';"));
ok('smoke_v2287 的 testChain pin 已更新为 185', s2287.includes('testChain === 215'));
ok('smoke_v2287 的哨兵 pin 已更新为二百一十五件套（二百一十四件套清除）', s2287.includes('二百一十五件套（二百一十四件套清除）'));
ok('smoke_v2286 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2286.includes("const GAME_VERSION = 'v23.90';"));
ok('smoke_v2286 的 哨兵 pin 已更新为二百一十五件套（二百一十四件套清除）', s2286.includes('二百一十五件套（二百一十四件套清除）'));
