...
ok('GAME_VERSION 恒等于 v22.89', GAME_VERSION === 'v23.03', GAME_VERSION);
...
// 2. 源级落位
ok('data.js GAME_VERSION 字面量为 v22.89', dataSrc.includes("const GAME_VERSION = 'v23.03';"));
...
ok('README 件套口径为一百九十九件套（一百九十八件套清除）且旧 184 口径零残留',
  readme.includes('冒烟一百九十九件套（一百九十八件套清除）') && !readme.includes('一百八十四件套（一百八十三件套清' + '除）'));
...
ok('package.json test 串共 185 件套', testChain === 199, String(testChain));
ok('CHANGELOG 含 v22.89 条目（顶 pin）', changelog.startsWith('## v23.03 '));
...
ok('smoke_v2288 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2288.includes("const GAME_VERSION = 'v23.03';"));
ok('smoke_v2288 的 CHANGELOG 顶 pin 已更新为 ## v22.89', s2288.includes("startsWith('## v23.03 '"));
ok('smoke_v2288 的件套 pin 已更新为一百九十九件套（一百九十八件套清除）', s2288.includes('一百九十九件套（一百九十八件套清除）'));
...
ok('smoke_v2288 的 package 串尾 pin 已延伸至 smoke_v2289_winprog',
  s2288.includes('node tests/smoke_v2288_scrollhint.mjs && node tests/smoke_v2289_winprog.mjs && node tests/smoke_v2290_statlink.mjs && node tests/smoke_v2291_lampguide.mjs && node tests/smoke_v2292_cavewatch.mjs && node tests/smoke_v2293_deadsave.mjs && node tests/smoke_v2294_crystalwatch.mjs && node tests/smoke_v2295_deadprog.mjs && node tests/smoke_v2296_endingprog.mjs && node tests/smoke_v2297_chestmid.mjs && node tests/smoke_v2298_encnum.mjs && node tests/smoke_v2299_crosslink.mjs && node tests/smoke_v2300_sidemore.mjs && node tests/smoke_v2301_eco.mjs && node tests/smoke_v2302_cmdprev.mjs && node tests/smoke_v2303_rushnum.mjs"'));
ok('smoke_v2288 的 testChain pin 已更新为 185', s2288.includes('testChain === 199'));
ok('smoke_v2287 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2287.includes("const GAME_VERSION = 'v23.03';"));
ok('smoke_v2287 的 testChain pin 已更新为 185', s2287.includes('testChain === 199'));
ok('smoke_v2287 的哨兵 pin 已更新为一百九十九件套（一百九十八件套清除）', s2287.includes('一百九十九件套（一百九十八件套清除）'));
ok('smoke_v2286 的 GAME_VERSION 字面量 pin 已更新为 v22.89', s2286.includes("const GAME_VERSION = 'v23.03';"));
ok('smoke_v2286 的 哨兵 pin 已更新为一百九十九件套（一百九十八件套清除）', s2286.includes('一百九十九件套（一百九十八件套清除）'));
