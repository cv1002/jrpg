...
ok('smoke_v2176 的 README 件套口径断言已随新现实更新（七十五件套 pin 零残留，七十六件套落位）',
  s2176.includes('一百六十三件套（一百六十二件套清除）') && !s2176.includes('七十五件套（七十四件套清除）'));
...
ok('smoke_v2168 的 README 成就 pin 已随新现实更新（28 项 pin 零残留，31 项双处落位）',
  s2168.includes("readme.includes('成就一览（全部 51 项进度'") && !s2168.includes('全部 28 项进度'));
ok('smoke_v2168 对 smoke_v2159 的 README pin 复查已随新现实更新（31 项双处落位）',
  s2168.includes("s2159.includes(\"readme.includes('成就一览（全部 51 项进度')\")"));
...
ok('smoke_v2159 的 README 成就 pin 已随新现实更新（28 项 pin 零残留，31 项双处落位）',
  s2159.includes("readme.includes('成就一览（全部 51 项进度'") && !s2159.includes('全部 28 项进度'));
