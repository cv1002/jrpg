...
ok('README 件套口径为七十四件套（七十三件套清除）', readme.includes('七十四件套（七十三件套清除）'));
...
ok('smoke_v2176 的 README 件套口径断言已随新现实更新（七十三件套 pin 零残留，七十四件套落位）',
  s2176.includes('七十四件套（七十三件套清除）') && !s2176.includes('七十三件套（七十二件套清除）'));
