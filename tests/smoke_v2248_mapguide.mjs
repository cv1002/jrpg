...
ok('GAME_VERSION 字面量已为 v22.48（旧 v22.47 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.68';") && !dSrc.includes("const GAME_VERSION = 'v22." + "47';"));
...
ok('CHANGELOG 顶部已追加 v22.48 条目', changelog.startsWith('## v23.68'));
...
ok('smoke_v2247 的 GAME_VERSION 字面量 pin 已更新为 v22.48（旧 v22.47 零残留）',
  s2247.includes("const GAME_VERSION = 'v23.68';") && !s2247.includes("const GAME_VERSION = 'v22." + "47';"));
