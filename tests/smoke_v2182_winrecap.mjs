...
ok('README 件套口径已更新为一百零二件套（一百零一件套清除）',
  readme.includes('冒烟一百零二件套（一百零一件套清除）') && !readme.includes('冒烟七十七件套（七十六件套清除）'));
...
for (const [nm, src] of [['smoke_v2181', s2181], ['smoke_v2180', s2180], ['smoke_v2179', s2179], ['smoke_v2178', s2178], ['smoke_v2177', s2177], ['smoke_v2176', s2176]]) {
  ok(`${nm} 的 README 件套 pin 已随新现实更新为一百零二件套（一百零一件套清除）`,
    src.includes('一百零二件套（一百零一件套清除）') && !src.includes('七十七件套（七十六件套清除）'));
}
ok('smoke_v2181 的 GAME_VERSION 字面量 pin 已随新现实更新为 v21.84',
  s2181.includes("const GAME_VERSION = 'v22.6';"));
