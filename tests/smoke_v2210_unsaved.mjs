...
ok('GAME_VERSION 字面量已为 v22.10（本版独占精确锚点）', GAME_VERSION === 'v22.62', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.10', dataSrc.includes("const GAME_VERSION = 'v22.62';"));
...
ok('README 件套口径为一百五十八件套（一百五十七件套清除）',
  readme.includes('冒烟一百五十八件套（一百五十七件套清除）') && !readme.includes('冒烟一百零五件套（一百零四件套清' + '除）'));
