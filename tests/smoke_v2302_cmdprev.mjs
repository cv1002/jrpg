...
ok('data.js GAME_VERSION 字面量已为 v23.02（旧 v23.01 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.38';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "01';"));
...
ok('CHANGELOG 顶部已追加 v23.02 条目', changelog.startsWith('## v23.38 '));
...
ok('smoke_v2301 的 GAME_VERSION 字面量 pin 已更新为 v23.02', s2301.includes("const GAME_VERSION = 'v23.38';"));
ok('smoke_v2301 的 CHANGELOG 顶 pin 已更新为 ## v23.02',
  s2301.includes("startsWith('## v23.38 '"));
