...
// （冒烟二百二十四件套（二百二十三件套清除）/串尾/入库 198 份/顶 pin）+ 姊妹件套 pin（smoke_v2301
...
ok('data.js GAME_VERSION 字面量已为 v23.02（旧 v23.01 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v24.00';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "01';"));
...
ok('package.json test 串共 198 件套', testChain === 224, String(testChain));
ok('CHANGELOG 顶部已追加 v23.02 条目', changelog.startsWith('## v24.00 '));
...
ok('smoke_v2301 的 GAME_VERSION 字面量 pin 已更新为 v23.02', s2301.includes("const GAME_VERSION = 'v24.00';"));
ok('smoke_v2301 的 CHANGELOG 顶 pin 已更新为 ## v23.02',
  s2301.includes("startsWith('## v24.00 '"));
ok('smoke_v2301 的件套 pin 已更新为二百二十四件套（二百二十三件套清除）',
  s2301.includes('二百二十四件套（二百二十三件套清除）'));
...
ok('smoke_v2301 的 testChain pin 已更新为 198', s2301.includes('testChain === 224'));
