...
ok('data.js GAME_VERSION 字面量为 v22.85', dataSrc.includes("const GAME_VERSION = 'v23.95'"));
...
ok('GAME_VERSION 导出恒等于 v22.85', GAME_VERSION === 'v23.95', GAME_VERSION);
...
ok('README 件套口径为二百一十九件套（二百一十八件套清除）且旧 180 口径零残留',
  readme.includes('冒烟二百一十九件套（二百一十八件套清除）') && !readme.includes('冒烟一百八十件套（一百七十九件套清' + '除）'));
...
ok('package.json test 串共 181 件套', testChain === 219, String(testChain));
ok('CHANGELOG 含 v22.85 条目（顶 pin）', changelog.startsWith('## v23.95 '));
...
ok('smoke_v2284 的 GAME_VERSION 字面量 pin 已更新为 v22.85', s2284.includes("const GAME_VERSION = 'v23.95';"));
ok('smoke_v2284 的 CHANGELOG 顶 pin 已更新为 ## v22.85', s2284.includes("startsWith('## v23.95 '"));
...
ok('smoke_v2283 的 GAME_VERSION 字面量 pin 已更新为 v22.85', s2283.includes("const GAME_VERSION = 'v23.95';"));
ok('smoke_v2283 的 CHANGELOG 顶 pin 已更新为 ## v22.85', s2283.includes("startsWith('## v23.95 '"));
ok('smoke_v2283 的 testChain pin 已更新为 181', s2283.includes('testChain === 219'));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.85', s2282.includes("const GAME_VERSION = 'v23.95';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.85', s2282.includes("startsWith('## v23.95 '"));
ok('smoke_v2282 的 testChain pin 已更新为 181', s2282.includes('testChain === 219'));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.85', s2281.includes("const GAME_VERSION = 'v23.95';"));
