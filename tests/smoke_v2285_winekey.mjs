...
ok('data.js GAME_VERSION 字面量为 v22.85', dataSrc.includes("const GAME_VERSION = 'v22.94'"));
...
ok('GAME_VERSION 导出恒等于 v22.85', GAME_VERSION === 'v22.94', GAME_VERSION);
...
ok('README 件套口径为一百九十件套（一百八十九件套清除）且旧 180 口径零残留',
  readme.includes('冒烟一百九十件套（一百八十九件套清除）') && !readme.includes('冒烟一百八十件套（一百七十九件套清' + '除）'));
...
ok('package.json test 串共 181 件套', testChain === 190, String(testChain));
ok('CHANGELOG 含 v22.85 条目（顶 pin）', changelog.startsWith('## v22.94 '));
...
ok('smoke_v2284 的 GAME_VERSION 字面量 pin 已更新为 v22.85', s2284.includes("const GAME_VERSION = 'v22.94';"));
ok('smoke_v2284 的 CHANGELOG 顶 pin 已更新为 ## v22.85', s2284.includes("startsWith('## v22.94 '"));
ok('smoke_v2284 的件套 pin 已更新为一百九十件套（一百八十九件套清除）', s2284.includes('一百九十件套（一百八十九件套清除）'));
ok('smoke_v2284 的 README 串尾 pin 已延伸至 smoke_v2285_winekey', s2284.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog + smoke_v2290_statlink + smoke_v2291_lampguide + smoke_v2292_cavewatch + smoke_v2293_deadsave + smoke_v2294_crystalwatch（npm test 串跑）'));
...
ok('smoke_v2283 的 GAME_VERSION 字面量 pin 已更新为 v22.85', s2283.includes("const GAME_VERSION = 'v22.94';"));
ok('smoke_v2283 的 CHANGELOG 顶 pin 已更新为 ## v22.85', s2283.includes("startsWith('## v22.94 '"));
ok('smoke_v2283 的 testChain pin 已更新为 181', s2283.includes('testChain === 190'));
ok('smoke_v2283 的 README 串尾 pin 已延伸至 smoke_v2285_winekey', s2283.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog + smoke_v2290_statlink + smoke_v2291_lampguide + smoke_v2292_cavewatch + smoke_v2293_deadsave + smoke_v2294_crystalwatch（npm test 串跑）'));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.85', s2282.includes("const GAME_VERSION = 'v22.94';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.85', s2282.includes("startsWith('## v22.94 '"));
ok('smoke_v2282 的 testChain pin 已更新为 181', s2282.includes('testChain === 190'));
ok('smoke_v2282 的 README 串尾 pin 已延伸至 smoke_v2285_winekey', s2282.includes('smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog + smoke_v2290_statlink + smoke_v2291_lampguide + smoke_v2292_cavewatch + smoke_v2293_deadsave + smoke_v2294_crystalwatch（npm test 串跑）'));
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.85', s2281.includes("const GAME_VERSION = 'v22.94';"));
