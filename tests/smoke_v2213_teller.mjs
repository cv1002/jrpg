...
ok('GAME_VERSION 字面量已更新为 v22.13（旧 v22.12 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.13';") && !dSrc.includes("const GAME_VERSION = 'v22.12';"));
...
ok('README tests 树收录 smoke_v2213_teller 且位于串尾', readme.includes('smoke_v2212_volume + smoke_v2213_teller（npm test 串跑）'));
...
ok('s2212 GAME_VERSION 字面量 pin 已随新现实更新为 v22.13',
  s2212.includes("const GAME_VERSION = 'v22.13';") && !s2212.includes("=== 'v22.12'"));
