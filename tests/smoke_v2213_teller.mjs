...
ok('GAME_VERSION 字面量已更新为 v22.13（旧 v22.12 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.35';") && !dSrc.includes("const GAME_VERSION = 'v22.12';"));
...
ok('s2212 GAME_VERSION 字面量 pin 已随新现实更新为 v22.13',
  s2212.includes("const GAME_VERSION = 'v22.35';") && !s2212.includes("=== 'v22.12'"));
ok('s2212 件套 pin 已随新现实更新为一百一十二件套', s2212.includes('一百三十一件套（一百三十件套清除）'));
ok('s2211 件套 pin 已随新现实更新为一百一十二件套', s2211.includes('一百三十一件套（一百三十件套清除）'));
