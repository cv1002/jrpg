...
ok('data.js GAME_VERSION 字面量已为 v23.92（旧 v23.91 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v24.00';") && !dSrc.includes("const GAME_VERSION = 'v23.9" + "1';"));
...
ok('package.json test 串共 216 件套', testChain === 224, String(testChain));
...
ok('CHANGELOG 顶部已追加 v23.92 条目（星铁剑）', changelog.startsWith('## v24.00 '));
