...
ok('GAME_VERSION 格式合法且已越过 v21.96', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 98)), GAME_VERSION);
ok('GAME_VERSION 字面量已为 v21.97', GAME_VERSION === 'v22.98', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.97', dataSrc.includes("const GAME_VERSION = 'v22.98';"));
...
ok('README 件套口径为一百九十四件套（一百九十三件套清除）',
  readme.includes('冒烟一百九十四件套（一百九十三件套清除）') && !readme.includes('冒烟九十二件套（九十一件套清除）'));
