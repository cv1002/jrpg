...
ok('data.js GAME_VERSION 字面量为 v22.96', dataSrc.includes("const GAME_VERSION = 'v23.71';"));
...
ok('CHANGELOG 顶部已追加 v22.96 条目', changelog.startsWith('## v23.71 '));
...
ok('smoke_v2295 的 GAME_VERSION 字面量 pin 已更新为 v22.96', s2295.includes("const GAME_VERSION = 'v23.71';"));
ok('smoke_v2295 的 CHANGELOG 顶 pin 已更新为 ## v22.96', s2295.includes("startsWith('## v23.71 '"));
...
ok('smoke_v2294 的 GAME_VERSION 字面量 pin 已更新为 v22.96', s2294.includes("const GAME_VERSION = 'v23.71';"));
