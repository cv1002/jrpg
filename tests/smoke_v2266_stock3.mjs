...
ok('data.js GAME_VERSION 字面量已为 v22.66（旧 v22.65 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v22.97';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "65';"));
...
ok('README 件套口径为一百九十三件套（一百九十二件套清除）且旧 161 口径零残留',
  readme.includes('冒烟一百九十三件套（一百九十二件套清除）') && !readme.includes('冒烟一百六十一件套（一百六十件套清' + '除）'));
...
ok('package.json test 串共 162 件套', testChain === 193, String(testChain));
ok('CHANGELOG 顶为 v22.66 条目', changelog.startsWith('## v22.97 '));
...
ok('smoke_v2265 的 GAME_VERSION 字面量 pin 已更新为 v22.66', s2265.includes("const GAME_VERSION = 'v22.97';"));
ok('smoke_v2265 的 README 件套 pin 已随新现实更新为一百九十三件套（一百九十二件套清除）',
  s2265.includes('一百九十四件套（一百九十三件套清除）'));
ok('smoke_v2265 的 package.json 件套计数 pin 已更新为 === 162', s2265.includes('testChain === 193'));
ok('smoke_v2265 的 CHANGELOG 顶 pin 已更新为 ## v22.66', s2265.includes("startsWith('## v22.97')"));
...
ok('smoke_v2264 的 GAME_VERSION 字面量 pin 已更新为 v22.66', s2264.includes("const GAME_VERSION = 'v22.97';"));
ok('smoke_v2264 的 README 件套 pin 已随新现实更新为一百九十三件套（一百九十二件套清除）',
  s2264.includes('一百九十四件套（一百九十三件套清除）'));
ok('smoke_v2264 的 package.json 件套计数 pin 已更新为 === 162', s2264.includes('testChain === 193'));
ok('smoke_v2264 的 CHANGELOG 顶 pin 已更新为 ## v22.66', s2264.includes("startsWith('## v22.97')"));
...
ok('smoke_v2263 的 GAME_VERSION 字面量 pin 已更新为 v22.66', s2263.includes("const GAME_VERSION = 'v22.97';"));
ok('smoke_v2263 的 README 件套 pin 已随新现实更新为一百九十三件套（一百九十二件套清除）',
  s2263.includes('一百九十四件套（一百九十三件套清除）'));
ok('smoke_v2263 的 package.json 件套计数 pin 已更新为 === 162', s2263.includes('testChain === 193'));
ok('smoke_v2263 的 CHANGELOG 顶 pin 已更新为 ## v22.66', s2263.includes("startsWith('## v22.97')"));
...
ok('smoke_v2263 的 package.json 串尾 plain pin 已延伸至 smoke_v2266_stock3',
  s2263.includes('smoke_v2263_ptime3.mjs && node tests/smoke_v2264_hunt3.mjs && node tests/smoke_v2265_lucky3.mjs && node tests/smoke_v2266_stock3.mjs && node tests/smoke_v2267_elixir3.mjs && node tests/smoke_v2268_brew3.mjs && node tests/smoke_v2269_mush3.mjs && node tests/smoke_v2270_outstep.mjs && node tests/smoke_v2271_outstep2.mjs && node tests/smoke_v2272_scholar2.mjs && node tests/smoke_v2273_seen5.mjs && node tests/smoke_v2274_seen2.mjs && node tests/smoke_v2275_codexempty.mjs && node tests/smoke_v2276_lampkid.mjs && node tests/smoke_v2277_pondhint.mjs && node tests/smoke_v2278_mushguide.mjs && node tests/smoke_v2279_lampwell.mjs && node tests/smoke_v2280_grainfield.mjs && node tests/smoke_v2281_starwell.mjs && node tests/smoke_v2282_archgate.mjs && node tests/smoke_v2283_menuekey.mjs && node tests/smoke_v2284_skillekey.mjs && node tests/smoke_v2285_winekey.mjs && node tests/smoke_v2286_titleekey.mjs && node tests/smoke_v2287_trueroute.mjs && node tests/smoke_v2288_scrollhint.mjs && node tests/smoke_v2289_winprog.mjs && node tests/smoke_v2290_statlink.mjs && node tests/smoke_v2291_lampguide.mjs && node tests/smoke_v2292_cavewatch.mjs && node tests/smoke_v2293_deadsave.mjs && node tests/smoke_v2294_crystalwatch.mjs && node tests/smoke_v2295_deadprog.mjs && node tests/smoke_v2296_endingprog.mjs && node tests/smoke_v2297_chestmid.mjs"'));
ok('smoke_v2262 的 GAME_VERSION 字面量 pin 已更新为 v22.66', s2262.includes("const GAME_VERSION = 'v22.97';"));
...
ok('smoke_v2261 的 GAME_VERSION 字面量 pin 已更新为 v22.66', s2261.includes("const GAME_VERSION = 'v22.97';"));
...
ok('smoke_v2260 的 package.json 件套计数 pin 已更新为 === 162', s2260.includes('testChain === 193'));
ok('smoke_v2260 的 CHANGELOG 顶 pin 已更新为 ## v22.66', s2260.includes("startsWith('## v22.97')"));
...
ok('smoke_v2259 的 GAME_VERSION 字面量 pin 已更新为 v22.66', s2259.includes("const GAME_VERSION = 'v22.97';"));
ok('smoke_v2259 的 README 件套 pin 已随新现实更新为一百九十三件套（一百九十二件套清除）',
  s2259.includes('一百九十四件套（一百九十三件套清除）'));
ok('smoke_v2259 的 package.json 件套计数 pin 已更新为 === 162', s2259.includes('testChain === 193'));
ok('smoke_v2259 的 CHANGELOG 顶 pin 已更新为 ## v22.66', s2259.includes("startsWith('## v22.97')"));
ok('smoke_v2258 的 GAME_VERSION 字面量 pin 已更新为 v22.66', s2258.includes("const GAME_VERSION = 'v22.97';"));
...
ok('v2143-45「件套守护领先一位」哨兵链已推进至 163（一百九十三件套（一百九十二件套清除））',
