...
ok('GAME_VERSION 字面量已为 v22.36（旧 v22.35 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.76';") && !dSrc.includes("const GAME_VERSION = 'v22." + "35';"));
...
ok('README 件套口径为一百七十二件套（一百七十一件套清除）',
  readme.includes('冒烟一百七十二件套（一百七十一件套清除）') && !readme.includes('冒烟一百三十一件套（一百三十件套清' + '除）'));
...
ok('package.json test 串共 132 件套', testChain === 172, String(testChain));
...
ok('smoke_v2235 的 GAME_VERSION 字面量 pin 已更新为 v22.36', s2235.includes("const GAME_VERSION = 'v22.76';"));
ok('smoke_v2235 的 GAME_VERSION 恒等 pin 已更新为 === v22.36', s2235.includes("GAME_VERSION === 'v22.76'"));
...
ok('smoke_v2235 的 package.json 件套计数 pin 已更新为 === 132', s2235.includes('testChain === 172'));
ok('smoke_v2235 的 README 件套口径 pin 已更新为一百三十二件套', s2235.includes('冒烟一百七十二件套（一百七十一件套清除）'));
ok('smoke_v2234 的 GAME_VERSION 字面量 pin 已更新为 v22.36', s2234.includes("const GAME_VERSION = 'v22.76';"));
ok('smoke_v2233 的 GAME_VERSION 恒等 pin 已更新为 === v22.36', s2233.includes("GAME_VERSION === 'v22.76'"));
...
ok('smoke_v2230 的 GAME_VERSION 恒等 pin 已更新为 === v22.36', s2230.includes("GAME_VERSION === 'v22.76'"));
ok('smoke_v2229 的 GAME_VERSION 恒等 pin 已更新为 === v22.36', s2229.includes("GAME_VERSION === 'v22.76'"));
ok('smoke_v2226 的 GAME_VERSION 字面量 pin 已更新为 v22.36', s2226.includes("const GAME_VERSION = 'v22.76';"));
