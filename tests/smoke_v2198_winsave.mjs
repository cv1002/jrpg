...
ok('GAME_VERSION 字面量已为 v21.98', GAME_VERSION === 'v22.30', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.98', dataSrc.includes("const GAME_VERSION = 'v22.30';"));
...
ok('README 件套口径为一百二十六件套（一百二十五件套清除）',
  readme.includes('冒烟一百二十六件套（一百二十五件套清除）') && !readme.includes('冒烟九十三件套（九十二件套清' + '除）'));
