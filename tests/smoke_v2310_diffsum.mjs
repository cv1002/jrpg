...
ok('data.js GAME_VERSION 字面量已为 v23.10（旧 v23.09 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.33';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "09';"));
...
ok('CHANGELOG 顶部已追加 v23.10 条目', changelog.startsWith('## v23.33 '));
...
ok('smoke_v2309 的 GAME_VERSION 字面量 pin 已更新为 v23.10', s2309.includes("const GAME_VERSION = 'v23.33';"));
ok('smoke_v2309 的 CHANGELOG 顶 pin 已更新为 ## v23.10',
  s2309.includes("startsWith('## v23.33 "));
