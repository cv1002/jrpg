...
ok('GAME_VERSION 字面量已为 v22.53（旧 v22.52 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.53';") && !dSrc.includes("const GAME_VERSION = 'v22." + "52';"));
...
ok('CHANGELOG 顶部已追加 v22.53 条目', changelog.startsWith('## v23.53'));
...
ok('smoke_v2252 的 GAME_VERSION 字面量 pin 已更新为 v22.53（旧 v22.52 零残留）',
  s2252.includes("const GAME_VERSION = 'v23.53';") && !s2252.includes("const GAME_VERSION = 'v22." + "52';"));
...
ok('smoke_v2252 的 CHANGELOG pin 已更新为 ## v22.53', s2252.includes("startsWith('## v23.53')"));
