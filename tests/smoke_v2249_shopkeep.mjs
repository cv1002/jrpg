...
ok('GAME_VERSION 字面量已为 v22.49（旧 v22.48 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.55';") && !dSrc.includes("const GAME_VERSION = 'v22." + "48';"));
...
ok('CHANGELOG 顶部已追加 v22.49 条目', changelog.startsWith('## v23.55'));
...
ok('smoke_v2248 的 GAME_VERSION 字面量 pin 已更新为 v22.49（旧 v22.48 零残留）',
  s2248.includes("const GAME_VERSION = 'v23.55';") && !s2248.includes("const GAME_VERSION = 'v22." + "48';"));
