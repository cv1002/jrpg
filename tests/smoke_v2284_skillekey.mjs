...
ok('data.js GAME_VERSION 字面量为 v22.84', dataSrc.includes("const GAME_VERSION = 'v22.93'"));
...
ok('README 件套口径为一百八十九件套（一百八十八件套清除）且旧 179 口径零残留',
  readme.includes('冒烟一百八十九件套（一百八十八件套清除）') && !readme.includes('冒烟一百七十九件套（一百七十八件套清' + '除）'));
...
ok('package.json test 串共 180 件套', testChain === 189, String(testChain));
ok('CHANGELOG 含 v22.84 条目（顶 pin）', changelog.startsWith('## v22.93 '));
...
ok('smoke_v2283 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2283.includes("const GAME_VERSION = 'v22.93';"));
ok('smoke_v2283 的 CHANGELOG 顶 pin 已更新为 ## v22.84', s2283.includes("startsWith('## v22.93 '"));
ok('smoke_v2283 的件套 pin 已更新为一百八十九件套（一百八十八件套清除）', s2283.includes('一百八十九件套（一百八十八件套清除）'));
ok('smoke_v2283 的 README 串尾 pin 已延伸至 smoke_v2284_skillekey', s2283.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog + smoke_v2290_statlink + smoke_v2291_lampguide + smoke_v2292_cavewatch + smoke_v2293_deadsave（npm test 串跑）'));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2282.includes("const GAME_VERSION = 'v22.93';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.84', s2282.includes("startsWith('## v22.93 '"));
ok('smoke_v2282 的 testChain pin 已更新为 180', s2282.includes('testChain === 189'));
ok('smoke_v2282 的 README 串尾 pin 已延伸至 smoke_v2284_skillekey', s2282.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog + smoke_v2290_statlink + smoke_v2291_lampguide + smoke_v2292_cavewatch + smoke_v2293_deadsave（npm test 串跑）'));
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2281.includes("const GAME_VERSION = 'v22.93';"));
