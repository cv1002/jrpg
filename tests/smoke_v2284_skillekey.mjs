...
ok('data.js GAME_VERSION 字面量为 v22.84', dataSrc.includes("const GAME_VERSION = 'v23.88'"));
...
ok('CHANGELOG 含 v22.84 条目（顶 pin）', changelog.startsWith('## v23.88 '));
...
ok('smoke_v2283 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2283.includes("const GAME_VERSION = 'v23.88';"));
ok('smoke_v2283 的 CHANGELOG 顶 pin 已更新为 ## v22.84', s2283.includes("startsWith('## v23.88 '"));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2282.includes("const GAME_VERSION = 'v23.88';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.84', s2282.includes("startsWith('## v23.88 '"));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2281.includes("const GAME_VERSION = 'v23.88';"));
