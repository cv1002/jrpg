...
ok('data.js GAME_VERSION 字面量为 v22.84', dataSrc.includes("const GAME_VERSION = 'v23.97'"));
...
ok('r[2] 含新增「技能菜单数字键1-8快捷直发」（v21.81 口径随 v23.55 第八招更新）',
  typeof row[2] === 'string' && row[2].includes('技能菜单数字键1-8快捷直发'));
...
ok('SKILL_DATA 共 8 招（v23.34 标题计数分母——与 v21.83 七招容量 / v23.55 八招容量 / smoke_v2306 契约同读一份源）', Object.keys(SKILL_DATA).length === 8, String(Object.keys(SKILL_DATA).length));
...
ok('README 件套口径为二百二十一件套（二百二十件套清除）且旧 179 口径零残留',
  readme.includes('冒烟二百二十一件套（二百二十件套清除）') && !readme.includes('冒烟一百七十九件套（一百七十八件套清' + '除）'));
...
ok('package.json test 串共 180 件套', testChain === 221, String(testChain));
ok('CHANGELOG 含 v22.84 条目（顶 pin）', changelog.startsWith('## v23.97 '));
...
ok('smoke_v2283 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2283.includes("const GAME_VERSION = 'v23.97';"));
ok('smoke_v2283 的 CHANGELOG 顶 pin 已更新为 ## v22.84', s2283.includes("startsWith('## v23.97 '"));
ok('smoke_v2283 的件套 pin 已更新为二百二十一件套（二百二十件套清除）', s2283.includes('二百二十一件套（二百二十件套清除）'));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2282.includes("const GAME_VERSION = 'v23.97';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.84', s2282.includes("startsWith('## v23.97 '"));
ok('smoke_v2282 的 testChain pin 已更新为 180', s2282.includes('testChain === 221'));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.84', s2281.includes("const GAME_VERSION = 'v23.97';"));
