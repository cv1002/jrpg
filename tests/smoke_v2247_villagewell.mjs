...
ok('GAME_VERSION 字面量已为 v22.47（旧 v22.46 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.17';") && !dSrc.includes("const GAME_VERSION = 'v22." + "46';"));
...
ok('CHANGELOG 顶部已追加 v22.47 条目', changelog.startsWith('## v23.16'));
...
ok('smoke_v2246 的 GAME_VERSION 字面量 pin 已更新为 v22.47（旧 v22.46 零残留）',
  s2246.includes("const GAME_VERSION = 'v23.17';") && !s2246.includes("const GAME_VERSION = 'v22." + "46';"));
