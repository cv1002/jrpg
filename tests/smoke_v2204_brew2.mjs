...
ok('GAME_VERSION 字面量已为 v22.4（本版独占精确锚点）', GAME_VERSION === 'v22.44', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.4', dataSrc.includes("const GAME_VERSION = 'v22.44';"));
...
ok('README 件套口径为一百四十件套（一百三十九件套清除）',
  readme.includes('冒烟一百四十件套（一百三十九件套清除）') && !readme.includes('冒烟九十九件套（九十八件套清' + '除）'));
