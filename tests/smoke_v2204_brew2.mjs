...
ok('GAME_VERSION 字面量已为 v22.4（本版独占精确锚点）', GAME_VERSION === 'v22.29', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.4', dataSrc.includes("const GAME_VERSION = 'v22.29';"));
...
ok('README 件套口径为一百二十五件套（一百二十四件套清除）',
  readme.includes('冒烟一百二十五件套（一百二十四件套清除）') && !readme.includes('冒烟九十九件套（九十八件套清' + '除）'));
