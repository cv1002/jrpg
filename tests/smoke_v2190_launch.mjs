...
ok('GAME_VERSION 格式合法且已越过 v21.89', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 95)), GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v21.90', dataSrc.includes("const GAME_VERSION = 'v22.95';"));
...
ok('README 件套口径为一百九十一件套（一百九十件套清除）',
  readme.includes('冒烟一百九十一件套（一百九十件套清除）') && !readme.includes('冒烟八十五件套（八十四件套清除）'));
