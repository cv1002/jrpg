...
ok('data.js GAME_VERSION 字面量已为 v23.08（旧 v23.07 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.50';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "07';"));
...
ok('CHANGELOG 顶部已追加 v23.08 条目', changelog.startsWith('## v23.50 '));
...
ok('smoke_v2307 的 GAME_VERSION 字面量 pin 已更新为 v23.08', s2307.includes("const GAME_VERSION = 'v23.50';"));
ok('smoke_v2307 的 CHANGELOG 顶 pin 已更新为 ## v23.08',
  s2307.includes("startsWith('## v23.50 "));
