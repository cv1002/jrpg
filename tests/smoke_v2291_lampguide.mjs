...
ok('GAME_VERSION 字面量已为 v22.91（旧 v22.90 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.25';") && !dSrc.includes("const GAME_VERSION = 'v22." + "90';"));
...
ok('CHANGELOG 顶部已追加 v22.91 条目', changelog.startsWith('## v23.25 '));
...
ok('smoke_v2290 的 GAME_VERSION 字面量 pin 已更新为 v22.91（旧 v22.90 零残留）',
  s2290.includes("const GAME_VERSION = 'v23.25';") && !s2290.includes("const GAME_VERSION = 'v22." + "90';"));
...
ok('smoke_v2290 的 CHANGELOG 顶 pin 已更新为 ## v22.91', s2290.includes("startsWith('## v23.25 '"));
