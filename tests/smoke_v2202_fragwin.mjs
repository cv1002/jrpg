...
ok('GAME_VERSION 字面量已为 v22.2', GAME_VERSION === 'v23.97', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.2', dataSrc.includes("const GAME_VERSION = 'v23.97';"));
...
ok('README 已同步（tests 树收录 smoke_v2202_fragwin + 九十八件套口径）',
  readme.includes('smoke_v2202_fragwin') && readme.includes('二百二十一件套（二百二十件套清除）'));
