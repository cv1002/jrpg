...
ok('GAME_VERSION 字面量已为 v22.2', GAME_VERSION === 'v22.18', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.2', dataSrc.includes("const GAME_VERSION = 'v22.18';"));
...
ok('README 已同步（tests 树收录 smoke_v2202_fragwin + 九十八件套口径）',
  readme.includes('smoke_v2202_fragwin') && readme.includes('一百一十四件套（一百一十三件套清除）'));
...
for (const nm of ['smoke_v2201_fragstatus.mjs', 'smoke_v2200_stock.mjs', 'smoke_v2199_rich2.mjs',
  ...
  ok(`${nm} 的 README tests 树尾 pin 已随新现实更新（+ smoke_v2202_fragwin）`,
    src.includes('smoke_v2201_fragstatus + smoke_v2202_fragwin + smoke_v2204_brew2 + smoke_v2209_achstatus + smoke_v2211_lampkid + smoke_v2212_volume + smoke_v2213_teller + smoke_v2214_mush + smoke_v2215_tutorvol + smoke_v2216_picker + smoke_v2217_elixir2 + smoke_v2218_mush2（npm test 串跑）'));
}
