...
ok('GAME_VERSION 字面量已为 v22.2', GAME_VERSION === 'v22.89', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.2', dataSrc.includes("const GAME_VERSION = 'v22.89';"));
...
ok('drawWin 页脚 P 口径与提示行零回归（v21.98，v22.85 起 Enter/E 双键）',
  winBlock.includes('按 Enter/E 观看尾声 · 按 P 存档 · 按 R 重开新档(连按两次)') && winBlock.includes('💡 本局战果未自动存档'));
...
ok('README 已同步（tests 树收录 smoke_v2202_fragwin + 九十八件套口径）',
  readme.includes('smoke_v2202_fragwin') && readme.includes('一百八十五件套（一百八十四件套清除）'));
