...
// 冒烟一百八十五件套（一百八十四件套清除）、v22.15 守护描述、README 上手表 [ / ] 行）、姊妹件套
...
ok('GAME_VERSION 字面量已为 v22.15（本版独占精确锚点）', GAME_VERSION === 'v22.89', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.15', dataSrc.includes("const GAME_VERSION = 'v22.89';"));
...
ok('smoke_v2214 的 README 件套 pin 已随新现实更新为一百八十五件套（一百八十四件套清除）',
  s2214.includes('一百八十五件套（一百八十四件套清除）'));
...
ok('smoke_v2214 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2214.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2214 的 GAME_VERSION 恒等 pin 已更新为 === v22.15',
  s2214.includes("GAME_VERSION === 'v22.89'"));
ok('smoke_v2213 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2213.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2212 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2212.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2192 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2192.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2181 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2181.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2179 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2179.includes("const GAME_VERSION = 'v22.89';"));
ok('smoke_v2176 件套 pin 已更新为一百八十五件套（一百八十四件套清除）',
  s2176.includes('一百八十五件套（一百八十四件套清除）'));
