...
// 冒烟一百一十一件套（一百一十件套清除）、v22.15 守护描述、README 上手表 [ / ] 行）、姊妹件套
// pin（v2214..v2176 一百一十一件套 / v2214..v2179 GAME_VERSION v22.15 / v2214..v2192 恒等
...
ok('GAME_VERSION 字面量已为 v22.15（本版独占精确锚点）', GAME_VERSION === 'v22.15', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.15', dataSrc.includes("const GAME_VERSION = 'v22.15';"));
...
// —— README 同步 ——
ok('README tests 树尾含 + smoke_v2215_tutorvol（npm test 串跑）', readme.includes('smoke_v2214_mush + smoke_v2215_tutorvol（npm test 串跑）'));
ok('README 件套口径为一百一十一件套（一百一十件套清除）', readme.includes('冒烟一百一十一件套（一百一十件套清除）') && !readme.includes('冒烟一百一十件套（一百零九件套清' + '除）'));
...
ok('package.json test 串收录 smoke_v2215_tutorvol（第 111 份）', pkg.includes('&& node tests/smoke_v2215_tutorvol.mjs"'));
ok('package.json test 串共 111 件套', testChain === 111, String(testChain));
ok('CHANGELOG 含 v22.15 条目', changelog.includes('## v22.15 '));

// —— 姊妹件套 pin（v2214..v2176 一百一十一件套 / v2214..v2179 GAME_VERSION v22.15 / 恒等 / 树尾）——
...
ok('smoke_v2214 的 README 件套 pin 已随新现实更新为一百一十一件套（一百一十件套清除）',
  s2214.includes('一百一十一件套（一百一十件套清除）'));
...
ok('smoke_v2214 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2214.includes("const GAME_VERSION = 'v22.15';"));
ok('smoke_v2214 的 GAME_VERSION 恒等 pin 已更新为 === v22.15',
  s2214.includes("GAME_VERSION === 'v22.15'"));
ok('smoke_v2213 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2213.includes("const GAME_VERSION = 'v22.15';"));
ok('smoke_v2212 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2212.includes("const GAME_VERSION = 'v22.15';"));
ok('smoke_v2192 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2192.includes("const GAME_VERSION = 'v22.15';"));
ok('smoke_v2181 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2181.includes("const GAME_VERSION = 'v22.15';"));
ok('smoke_v2179 的 GAME_VERSION 字面量 pin 已更新为 v22.15',
  s2179.includes("const GAME_VERSION = 'v22.15';"));
ok('smoke_v2176 件套 pin 已更新为一百一十一件套（一百一十件套清除）',
  s2176.includes('一百一十一件套（一百一十件套清除）'));
