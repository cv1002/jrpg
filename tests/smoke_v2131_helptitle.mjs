...
const PAGE_COUNTS = [14, 8, 10, 10]; // v21.11/v21.23/v21.25/v21.27 巡检行数；v21.72 第 4 页新增「记忆碎片」行 9→10（见 smoke_v2172_helpfrag）；v22.37 第 2 页新增小地图图例两行 5→7；v22.43 第 2 页新增「遇敌槽 / 危险格」机制行 7→8（见 smoke_v2243_encguide）
try {
