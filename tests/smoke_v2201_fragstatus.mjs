...
ok('GAME_VERSION 字面量已为 v22.1', GAME_VERSION === 'v23.04', GAME_VERSION);
...
ok('data.js GAME_VERSION 字面量已更新为 v22.1', dataSrc.includes("const GAME_VERSION = 'v23.04';"));
...
ok('README 已同步（tests 树收录 smoke_v2201_fragstatus + 九十七件套口径）',
  readme.includes('smoke_v2201_fragstatus') && readme.includes('二百件套（一百九十九件套清除）'));
