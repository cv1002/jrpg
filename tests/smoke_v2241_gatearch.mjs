...
ok('GAME_VERSION 字面量已为 v22.41（旧 v22.40 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.73';") && !dSrc.includes("const GAME_VERSION = 'v22." + "40';"));
...
ok('smoke_v2240 的 GAME_VERSION 字面量 pin 已更新为 v22.42', s2240.includes("const GAME_VERSION = 'v23.73';"));
ok('smoke_v2240 的 GAME_VERSION 恒等 pin 已更新为 === v22.42', s2240.includes("GAME_VERSION === 'v23.73'"));
...
ok('smoke_v2239 的 GAME_VERSION 字面量 pin 已更新为 v22.42', s2239.includes("const GAME_VERSION = 'v23.73';"));
...
ok('smoke_v2238 的 GAME_VERSION 字面量 pin 已更新为 v22.42', s2238.includes("const GAME_VERSION = 'v23.73';"));
ok('smoke_v2235 的 GAME_VERSION 字面量 pin 已更新为 v22.42', s2235.includes("const GAME_VERSION = 'v23.73';"));
ok('smoke_v2235 的 NPC 总数 pin 保持 30（零 NPC 变更）', s2235.includes('NPC_SPOTS).length === 38'));
ok('smoke_v2234 的 GAME_VERSION 恒等 pin 已更新为 === v22.42', s2234.includes("GAME_VERSION === 'v23.73'"));
ok('smoke_v2230 的 GAME_VERSION 恒等 pin 已更新为 === v22.42', s2230.includes("GAME_VERSION === 'v23.73'"));
...
ok('smoke_v2228 的 GAME_VERSION 字面量 pin 已更新为 v22.41 且旧代零残留复查仍在（v22.27 风格）',
  s2228.includes("const GAME_VERSION = 'v23.73';") && s2228.includes("'v22.") && s2228.includes("27';"));
