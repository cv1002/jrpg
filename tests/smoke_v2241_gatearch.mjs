...
ok('GAME_VERSION 字面量已为 v22.41（旧 v22.40 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.41';") && !dSrc.includes("const GAME_VERSION = 'v22." + "40';"));
...
ok('README tests 树收录 smoke_v2241_gatearch 且位于串尾', readme.includes('smoke_v2240_tallgrass + smoke_v2241_gatearch（npm test 串跑）'));
ok('README 件套口径为一百三十七件套（一百三十六件套清除）',
  readme.includes('冒烟一百三十七件套（一百三十六件套清除）') && !readme.includes('冒烟一百三十六件套（一百三十五件套清' + '除）'));
...
ok('package.json test 串共 137 件套', testChain === 137, String(testChain));
...
ok('smoke_v2240 的 GAME_VERSION 字面量 pin 已更新为 v22.41', s2240.includes("const GAME_VERSION = 'v22.41';"));
ok('smoke_v2240 的 GAME_VERSION 恒等 pin 已更新为 === v22.41', s2240.includes("GAME_VERSION === 'v22.41'"));
ok('smoke_v2240 的 README 串尾 pin 已更新为 + smoke_v2241_gatearch',
  s2240.includes('smoke_v2240_tallgrass + smoke_v2241_gatearch（npm test 串跑）'));
ok('smoke_v2240 的 package.json 件套计数 pin 已更新为 === 137', s2240.includes('testChain === 137'));
ok('smoke_v2240 的 README 件套口径 pin 已更新为一百三十七件套', s2240.includes('冒烟一百三十七件套（一百三十六件套清除）'));
ok('smoke_v2239 的 GAME_VERSION 字面量 pin 已更新为 v22.41', s2239.includes("const GAME_VERSION = 'v22.41';"));
ok('smoke_v2239 的 README 串尾 pin 已更新为 + smoke_v2241_gatearch（NPC 总数/件套 pin 随新现实）',
  s2239.includes('smoke_v2240_tallgrass + smoke_v2241_gatearch（npm test 串跑）') && s2239.includes('testChain === 137'));
ok('smoke_v2238 的 GAME_VERSION 字面量 pin 已更新为 v22.41', s2238.includes("const GAME_VERSION = 'v22.41';"));
ok('smoke_v2235 的 GAME_VERSION 字面量 pin 已更新为 v22.41', s2235.includes("const GAME_VERSION = 'v22.41';"));
ok('smoke_v2235 的 NPC 总数 pin 保持 30（零 NPC 变更）', s2235.includes('NPC_SPOTS).length === 30'));
ok('smoke_v2234 的 GAME_VERSION 恒等 pin 已更新为 === v22.41', s2234.includes("GAME_VERSION === 'v22.41'"));
ok('smoke_v2230 的 GAME_VERSION 恒等 pin 已更新为 === v22.41', s2230.includes("GAME_VERSION === 'v22.41'"));
...
ok('smoke_v2226 的 plain 串尾锚逐字（node tests/smoke_v2240_tallgrass.mjs && node tests/smoke_v2241_gatearch.mjs"）',
  s2226.includes('node tests/smoke_v2240_tallgrass.mjs && node tests/smoke_v2241_gatearch.mjs"'));
ok('smoke_v2228 的 GAME_VERSION 字面量 pin 已更新为 v22.41 且旧代零残留复查仍在（v22.27 风格）',
  s2228.includes("const GAME_VERSION = 'v22.41';") && s2228.includes("'v22.") && s2228.includes("27';"));
