...
ok('data.js GAME_VERSION 字面量为 v22.95', dataSrc.includes("const GAME_VERSION = 'v23.95';"));
...
ok('README 件套口径为二百一十九件套（二百一十八件套清除）且旧 190 口径零残留',
  readme.includes('冒烟二百一十九件套（二百一十八件套清除）') && !readme.includes('冒烟一百九十件套（一百八十九件套清' + '除）'));
...
ok('package.json test 串共 191 件套', testChain === 219, String(testChain));
ok('CHANGELOG 顶部已追加 v22.95 条目', changelog.startsWith('## v23.95 '));
...
ok('smoke_v2294 的 GAME_VERSION 字面量 pin 已更新为 v22.95', s2294.includes("const GAME_VERSION = 'v23.95';"));
ok('smoke_v2294 的 CHANGELOG 顶 pin 已更新为 ## v22.95', s2294.includes("startsWith('## v23.95 '"));
ok('smoke_v2294 的件套 pin 已更新为二百一十九件套（二百一十八件套清除）', s2294.includes('二百一十九件套（二百一十八件套清除）'));
...
ok('smoke_v2294 的 testChain pin 已更新为 191', s2294.includes('testChain === 219'));
ok('smoke_v2294 的版本锚已推进至 >= 95', s2294.includes('_gv[1] >= 99'));
ok('smoke_v2293 的 GAME_VERSION 字面量 pin 已更新为 v22.95', s2293.includes("const GAME_VERSION = 'v23.95';"));
ok('smoke_v2293 的 testChain pin 已更新为 191', s2293.includes('testChain === 219'));
