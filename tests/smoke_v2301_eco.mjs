...
// README/package.json/CHANGELOG 同步（冒烟二百二十五件套（二百二十四件套清除）/串尾/入库 197 份/顶 pin）+
...
ok('data.js GAME_VERSION 字面量已为 v23.01（旧 v23.00 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v24.01';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "00';"));
...
ok('package.json test 串共 197 件套', testChain === 225, String(testChain));
ok('CHANGELOG 顶部已追加 v23.01 条目', changelog.startsWith('## v24.01 '));
...
ok('smoke_v2300 的 GAME_VERSION 字面量 pin 已更新为 v23.01', s2300.includes("const GAME_VERSION = 'v24.01';"));
ok('smoke_v2300 的 CHANGELOG 顶 pin 已更新为 ## v23.01',
  s2300.includes("startsWith('## v24.01 '"));
ok('smoke_v2300 的件套 pin 已更新为二百二十五件套（二百二十四件套清除）',
  s2300.includes('二百二十五件套（二百二十四件套清除）'));
...
ok('smoke_v2300 的 testChain pin 已更新为 197', s2300.includes('testChain === 225'));
