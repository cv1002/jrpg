...
ok('GAME_VERSION 字面量已为 v22.39（旧 v22.38 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.49';") && !dSrc.includes("const GAME_VERSION = 'v22." + "38';"));
...
ok('smoke_v2238 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2238.includes("const GAME_VERSION = 'v23.49';"));
ok('smoke_v2238 的 GAME_VERSION 恒等 pin 已更新为 === v22.39', s2238.includes("GAME_VERSION === 'v23.49'"));
...
ok('smoke_v2237 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2237.includes("const GAME_VERSION = 'v23.49';"));
ok('smoke_v2235 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2235.includes("const GAME_VERSION = 'v23.49';"));
ok('smoke_v2234 的 GAME_VERSION 恒等 pin 已更新为 === v22.39', s2234.includes("GAME_VERSION === 'v23.49'"));
