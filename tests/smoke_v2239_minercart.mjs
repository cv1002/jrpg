...
ok('GAME_VERSION 字面量已为 v22.39（旧 v22.38 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v24.01';") && !dSrc.includes("const GAME_VERSION = 'v22." + "38';"));
...
ok('README 件套口径为二百二十五件套（二百二十四件套清除）',
  readme.includes('冒烟二百二十五件套（二百二十四件套清除）') && !readme.includes('冒烟一百三十四件套（一百三十三件套清' + '除）'));
...
ok('package.json test 串共 135 件套', testChain === 225, String(testChain));
...
ok('smoke_v2238 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2238.includes("const GAME_VERSION = 'v24.01';"));
ok('smoke_v2238 的 GAME_VERSION 恒等 pin 已更新为 === v22.39', s2238.includes("GAME_VERSION === 'v24.01'"));
...
ok('smoke_v2238 的 package.json 件套计数 pin 已更新为 === 135', s2238.includes('testChain === 225'));
ok('smoke_v2238 的 README 件套口径 pin 已更新为一百三十五件套', s2238.includes('冒烟二百二十五件套（二百二十四件套清除）'));
ok('smoke_v2237 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2237.includes("const GAME_VERSION = 'v24.01';"));
ok('smoke_v2235 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2235.includes("const GAME_VERSION = 'v24.01';"));
ok('smoke_v2234 的 GAME_VERSION 恒等 pin 已更新为 === v22.39', s2234.includes("GAME_VERSION === 'v24.01'"));
