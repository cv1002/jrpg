...
ok('GAME_VERSION 字面量已为 v22.39（旧 v22.38 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v22.43';") && !dSrc.includes("const GAME_VERSION = 'v22." + "38';"));
...
ok('README tests 树收录 smoke_v2239_minercart 且位于串尾', readme.includes('smoke_v2238_starwell + smoke_v2240_tallgrass + smoke_v2241_gatearch + smoke_v2242_mushfield + smoke_v2243_encguide（npm test 串跑）'));
ok('README 件套口径为一百三十九件套（一百三十八件套清除）',
  readme.includes('冒烟一百三十九件套（一百三十八件套清除）') && !readme.includes('冒烟一百三十四件套（一百三十三件套清' + '除）'));
...
ok('package.json test 串共 135 件套', testChain === 139, String(testChain));
...
ok('smoke_v2238 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2238.includes("const GAME_VERSION = 'v22.43';"));
ok('smoke_v2238 的 GAME_VERSION 恒等 pin 已更新为 === v22.39', s2238.includes("GAME_VERSION === 'v22.43'"));
ok('smoke_v2238 的 README 串尾 pin 已更新为 + smoke_v2239_minercart',
  s2238.includes('smoke_v2237_minimaplegend + smoke_v2238_starwell + smoke_v2240_tallgrass + smoke_v2241_gatearch + smoke_v2242_mushfield + smoke_v2243_encguide（npm test 串跑）'));
ok('smoke_v2238 的 package.json 件套计数 pin 已更新为 === 135', s2238.includes('testChain === 139'));
ok('smoke_v2238 的 README 件套口径 pin 已更新为一百三十五件套', s2238.includes('冒烟一百三十九件套（一百三十八件套清除）'));
ok('smoke_v2237 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2237.includes("const GAME_VERSION = 'v22.43';"));
ok('smoke_v2235 的 GAME_VERSION 字面量 pin 已更新为 v22.39', s2235.includes("const GAME_VERSION = 'v22.43';"));
ok('smoke_v2234 的 GAME_VERSION 恒等 pin 已更新为 === v22.39', s2234.includes("GAME_VERSION === 'v22.43'"));
ok('smoke_v2228/v2229/v2230 的 regex 串尾锚已延伸至 smoke_v2239_minercart',
  s2228.includes('smoke_v2238_starwell\\.mjs && node tests\\/smoke_v2239_minercart\\.mjs && node tests\\/smoke_v2240_tallgrass\\.mjs && node tests\\/smoke_v2241_gatearch.mjs && node tests\\/smoke_v2242_mushfield.mjs && node tests\\/smoke_v2243_encguide.mjs"/.test(pkg)') &&
  s2229.includes('smoke_v2238_starwell\\.mjs && node tests\\/smoke_v2239_minercart\\.mjs && node tests\\/smoke_v2240_tallgrass\\.mjs && node tests\\/smoke_v2241_gatearch.mjs && node tests\\/smoke_v2242_mushfield.mjs && node tests\\/smoke_v2243_encguide.mjs"/.test(pkg)') &&
  s2230.includes('smoke_v2238_starwell\\.mjs && node tests\\/smoke_v2239_minercart\\.mjs && node tests\\/smoke_v2240_tallgrass\\.mjs && node tests\\/smoke_v2241_gatearch.mjs && node tests\\/smoke_v2242_mushfield.mjs && node tests\\/smoke_v2243_encguide.mjs"/.test(pkg)'));
