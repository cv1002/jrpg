...
ok('data.js GAME_VERSION 字面量已为 v23.07（旧 v23.06 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.21';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "06';"));
...
ok('CHANGELOG 顶部已追加 v23.07 条目', changelog.startsWith('## v23.21 '));
...
ok('smoke_v2306 的 GAME_VERSION 字面量 pin 已更新为 v23.07', s2306.includes("const GAME_VERSION = 'v23.21';"));
ok('smoke_v2306 的 CHANGELOG 顶 pin 已更新为 ## v23.07',
  s2306.includes("startsWith('## v23.21 "));
