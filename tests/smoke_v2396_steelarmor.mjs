...
ok('data.js GAME_VERSION 字面量已为 v23.96（旧 v23.95 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.99';") && !dSrc.includes("const GAME_VERSION = 'v23.9" + "5';"));
...
ok('package.json test 串共 220 件套', testChain === 223, String(testChain));
...
ok('package.json 串尾为 ... smoke_v2395_shopscroll.mjs && node tests/smoke_v2396_steelarmor.mjs && node tests/smoke_v2397_baserow.mjs && node tests/smoke_v2398_econrow.mjs && node tests/smoke_v2399_dmgformula.mjs"',
  pkg.includes('node tests/smoke_v2395_shopscroll.mjs && node tests/smoke_v2396_steelarmor.mjs && node tests/smoke_v2397_baserow.mjs && node tests/smoke_v2398_econrow.mjs && node tests/smoke_v2399_dmgformula.mjs"'));
...
ok('CHANGELOG 顶部已追加 v23.96 条目（精钢甲）', changelog.startsWith('## v23.99 '));
