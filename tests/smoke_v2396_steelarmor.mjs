...
ok('data.js GAME_VERSION 字面量已为 v23.96（旧 v23.95 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v24.03';") && !dSrc.includes("const GAME_VERSION = 'v23.9" + "5';"));
...
ok('package.json test 串共 220 件套', testChain === 227, String(testChain));
...
ok('package.json 串尾为 ... smoke_v2395_shopscroll.mjs && node tests/smoke_v2396_steelarmor.mjs && node tests/smoke_v2397_baserow.mjs && node tests/smoke_v2398_econrow.mjs && node tests/smoke_v2399_dmgformula.mjs && node tests/smoke_v2400_trialwarn.mjs && node tests/smoke_v2401_winbgm.mjs && node tests/smoke_v2402_firstwin.mjs && node tests/smoke_v2403_diffbattle.mjs"',
...
ok('CHANGELOG 顶部已追加 v23.96 条目（精钢甲）', changelog.startsWith('## v24.03 '));
