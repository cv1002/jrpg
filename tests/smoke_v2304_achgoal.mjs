...
// README/package.json/CHANGELOG 同步（冒烟二百一十六件套（二百一十五件套清除）/串尾/入库 200 份/顶 pin）+
...
ok('data.js GAME_VERSION 字面量已为 v23.04（旧 v23.03 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.92';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "03';"));
...
ok('ACH_LIST 共 76 项', ACH_LIST.length === 76, String(ACH_LIST.length));
...
ok('README 成就档位行 含 v23.04 补录注释与 ACH_LIST 引用（v23.13 补社交档/v23.72 补给药端口/v23.73 补休整档/v23.74 补消费档/v23.75 补移动档/v23.76 补步行档/v23.80 补遭遇档/v23.82 补收入档/v23.87 补败北档/v23.91 补昼夜档口径随新现实更新）', readme.includes('（v23.04 补录、v23.13 补社交档、v23.72 补给药端口、v23.73 补休整档、v23.74 补消费档、v23.75 补移动档、v23.76 补步行档、v23.80 补遭遇档、v23.82 补收入档、v23.87 补败北档、v23.91 补昼夜档）') && readme.includes('`ACH_LIST`'));
...
ok('README 件套口径为二百一十六件套（二百一十五件套清除）且旧 199 口径零残留',
  readme.includes('冒烟二百一十六件套（二百一十五件套清除）') && !readme.includes('冒烟一百九十九件套（一百九十八件套清' + '除）'));
...
ok('package.json test 串共 200 件套', testChain === 216, String(testChain));
ok('CHANGELOG 顶部已追加 v23.04 条目', changelog.startsWith('## v23.92 '));
...
ok('smoke_v2303 的 GAME_VERSION 字面量 pin 已更新为 v23.04', s2303.includes("const GAME_VERSION = 'v23.92';"));
ok('smoke_v2303 的 CHANGELOG 顶 pin 已更新为 ## v23.04',
  s2303.includes("startsWith('## v23.92 "));
ok('smoke_v2303 的件套 pin 已更新为二百一十六件套（二百一十五件套清除）',
  s2303.includes('二百一十六件套（二百一十五件套清除）'));
...
ok('smoke_v2303 的 testChain pin 已更新为 200', s2303.includes('testChain === 216'));
