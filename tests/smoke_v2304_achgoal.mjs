...
ok('data.js GAME_VERSION 字面量已为 v23.04（旧 v23.03 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.42';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "03';"));
...
ok('CHANGELOG 顶部已追加 v23.04 条目', changelog.startsWith('## v23.42 '));
...
ok('smoke_v2303 的 GAME_VERSION 字面量 pin 已更新为 v23.04', s2303.includes("const GAME_VERSION = 'v23.42';"));
ok('smoke_v2303 的 CHANGELOG 顶 pin 已更新为 ## v23.04',
  s2303.includes("startsWith('## v23.42 "));
