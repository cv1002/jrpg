...
ok('data.js GAME_VERSION 字面量已为 v23.04（旧 v23.03 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.74';") && !dataSrc.includes("const GAME_VERSION = 'v23." + "03';"));
...
ok('ACH_LIST 共 70 项', ACH_LIST.length === 70, String(ACH_LIST.length));
...
ok('README 成就档位行 含 v23.04 补录注释与 ACH_LIST 引用（v23.13 补社交档/v23.72 补给药端口/v23.73 补休整档口径随新现实更新）', readme.includes('（v23.04 补录、v23.13 补社交档、v23.72 补给药端口、v23.73 补休整档、v23.74 补消费档）') && readme.includes('`ACH_LIST`'));
...
ok('CHANGELOG 顶部已追加 v23.04 条目', changelog.startsWith('## v23.74 '));
...
ok('smoke_v2303 的 GAME_VERSION 字面量 pin 已更新为 v23.04', s2303.includes("const GAME_VERSION = 'v23.74';"));
ok('smoke_v2303 的 CHANGELOG 顶 pin 已更新为 ## v23.04',
  s2303.includes("startsWith('## v23.74 "));
