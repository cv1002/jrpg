...
ok('GAME_VERSION 格式合法且已越过 v21.75', !!_gv && (_gv[0] > 21 || (_gv[0] === 21 && _gv[1] >= 99)), GAME_VERSION);
...
ok('灯火同心（allquests）支线分母 v23.32 随新现实更新为 0/9（side_grain/side_tree 是支线，allchests 不是）',
