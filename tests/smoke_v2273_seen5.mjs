...
ok('data.js GAME_VERSION 字面量已为 v22.73（旧 v22.72 字面量零残留）',
  dataSrc.includes("const GAME_VERSION = 'v23.24';") && !dataSrc.includes("const GAME_VERSION = 'v22." + "72';"));
...
ok('CHANGELOG 含 v22.73 条目（顶 pin）', changelog.startsWith('## v23.24 '));
...
ok('smoke_v2272 的 GAME_VERSION 字面量 pin 已更新为 v22.73', s2272.includes("const GAME_VERSION = 'v23.24';"));
ok('smoke_v2272 的 CHANGELOG 顶 pin 已更新为 ## v22.73', s2272.includes("startsWith('## v23.24'") || s2272.includes("startsWith('## v22.78 '"));
