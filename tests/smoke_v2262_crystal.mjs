...
ok('GAME_VERSION 字面量已为 v22.62（旧 v22.61 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.86';") && !dSrc.includes("const GAME_VERSION = 'v22." + "61';"));
...
ok('data.js GAME_VERSION 已为 v23.28（旧 v23.27 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.86';") && !dSrc.includes("const GAME_VERSION = 'v23.27';"));
...
ok('CHANGELOG 顶为 v22.62 条目', changelog.startsWith('## v23.86 '));
...
ok('smoke_v2261 的 GAME_VERSION 字面量 pin 已更新为 v22.62', s2261.includes("const GAME_VERSION = 'v23.86';"));
...
ok('smoke_v2260 的 CHANGELOG 顶 pin 已更新为 ## v22.62', s2260.includes("startsWith('## v23.86')") || s2260.includes("startsWith('## v22.78 ')"));
...
ok('smoke_v2259 的 GAME_VERSION 字面量 pin 已更新为 v22.62', s2259.includes("const GAME_VERSION = 'v23.86';"));
