...
ok('灯火同心（allquests）支线分母 v23.57 随新现实更新为 0/11（side_grain/side_tree/side_wolf/side_snake 是支线，hardtrue 不是）',
...
ok('smoke_v2159 的 README 成就口径断言已随新现实更新（「28 项」pin 零残留，「29 项」双处落位）',
  s2159.includes("readme.includes('成就一览（全部 65 项进度')") && !s2159.includes('**28 项成就**'));
