...
ok('data.js GAME_VERSION 字面量为 v22.83', dataSrc.includes("const GAME_VERSION = 'v23.90'"));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.83', s2282.includes("const GAME_VERSION = 'v23.90';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.83', s2282.includes("startsWith('## v23.90'"));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.83', s2281.includes("const GAME_VERSION = 'v23.90';"));
ok('smoke_v2281 的 CHANGELOG 顶 pin 已更新为 ## v22.83', s2281.includes("startsWith('## v23.90 '"));
