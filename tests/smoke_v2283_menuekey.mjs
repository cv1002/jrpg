...
ok('data.js GAME_VERSION 字面量为 v22.83', dataSrc.includes("const GAME_VERSION = 'v22.91'"));
...
ok('package.json test 串共 179 件套', testChain === 187, String(testChain));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.83', s2282.includes("const GAME_VERSION = 'v22.91';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.83', s2282.includes("startsWith('## v22.91'"));
ok('smoke_v2282 的件套 pin 已更新为一百八十七件套（一百八十六件套清除）', s2282.includes('一百八十七件套（一百八十六件套清除）'));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.83', s2281.includes("const GAME_VERSION = 'v22.91';"));
ok('smoke_v2281 的 CHANGELOG 顶 pin 已更新为 ## v22.83', s2281.includes("startsWith('## v22.91 '"));
ok('smoke_v2281 的 testChain pin 已更新为 179', s2281.includes('testChain === 187'));
ok('smoke_v2281 的 README 串尾 pin 已延伸至 smoke_v2284_skillekey', s2281.includes('smoke_v2283_menuekey + smoke_v2284_skillekey + smoke_v2285_winekey + smoke_v2286_titleekey + smoke_v2287_trueroute + smoke_v2288_scrollhint + smoke_v2289_winprog + smoke_v2290_statlink + smoke_v2291_lampguide（npm test 串跑）'));
