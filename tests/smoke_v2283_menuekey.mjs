...
ok('data.js GAME_VERSION 字面量为 v22.83', dataSrc.includes("const GAME_VERSION = 'v22.99'"));
...
ok('package.json test 串共 179 件套', testChain === 195, String(testChain));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.83', s2282.includes("const GAME_VERSION = 'v22.99';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.83', s2282.includes("startsWith('## v22.99'"));
ok('smoke_v2282 的件套 pin 已更新为一百九十五件套（一百九十四件套清除）', s2282.includes('一百九十五件套（一百九十四件套清除）'));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.83', s2281.includes("const GAME_VERSION = 'v22.99';"));
ok('smoke_v2281 的 CHANGELOG 顶 pin 已更新为 ## v22.83', s2281.includes("startsWith('## v22.99 '"));
ok('smoke_v2281 的 testChain pin 已更新为 179', s2281.includes('testChain === 195'));
