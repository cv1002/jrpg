...
ok('data.js GAME_VERSION 字面量为 v22.83', dataSrc.includes("const GAME_VERSION = 'v23.95'"));
...
ok('package.json test 串共 179 件套', testChain === 219, String(testChain));
...
ok('smoke_v2282 的 GAME_VERSION 字面量 pin 已更新为 v22.83', s2282.includes("const GAME_VERSION = 'v23.95';"));
ok('smoke_v2282 的 CHANGELOG 顶 pin 已更新为 ## v22.83', s2282.includes("startsWith('## v23.95'"));
ok('smoke_v2282 的件套 pin 已更新为二百一十九件套（二百一十八件套清除）', s2282.includes('二百一十九件套（二百一十八件套清除）'));
...
ok('smoke_v2281 的 GAME_VERSION 字面量 pin 已更新为 v22.83', s2281.includes("const GAME_VERSION = 'v23.95';"));
ok('smoke_v2281 的 CHANGELOG 顶 pin 已更新为 ## v22.83', s2281.includes("startsWith('## v23.95 '"));
ok('smoke_v2281 的 testChain pin 已更新为 179', s2281.includes('testChain === 219'));
