...
ok('GAME_VERSION 字面量已为 v22.46（旧 v22.45 字面量零残留）',
  dSrc.includes("const GAME_VERSION = 'v23.33';") && !dSrc.includes("const GAME_VERSION = 'v22." + "45';"));
...
ok('CHANGELOG 顶部已追加 v22.46 条目', changelog.startsWith('## v23.33'));
...
ok('smoke_v2245 的 GAME_VERSION 字面量 pin 已更新为 v22.46（旧 v22.45 零残留）',
  s2245.includes("const GAME_VERSION = 'v23.33';") && !s2245.includes("const GAME_VERSION = 'v22." + "45';"));
